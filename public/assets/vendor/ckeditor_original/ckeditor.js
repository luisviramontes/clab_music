...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "L0QD", version: "4.16.0", revision: "17a1555f7f", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
                var c = window.CKEDITOR_BASEPATH || ""; if (!c) for (var b = document.getElementsByTagName("script"), d = 0; d < b.length; d++) { var h = b[d].src.match(a); if (h) { c = h[1]; break } } -1 == c.indexOf(":/") && "//" != c.slice(0, 2) && (c = 0 === c.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
                ...
                function a() {
                    ...
                    function k() { try { document.documentElement.doScroll("left") } catch (c) { setTimeout(k, 1); return } a() } b.push(c); "complete" === document.readyState && setTimeout(a, 1); if (1 == b.length) if (document.addEventListener) document.addEventListener("DOMContentLoaded",
                        a, !1), window.addEventListener("load", a, !1); else if (document.attachEvent) { document.attachEvent("onreadystatechange", a); window.attachEvent("onload", a); c = !1; try { c = !window.frameElement } catch (f) { } document.documentElement.doScroll && c && k() }
                }
            }()
    ...
    CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var d = CKEDITOR.event.prototype, b; for (b in d) null == a[b] && (a[b] = d[b]) }, CKEDITOR.event.prototype = function () {
        function a(a) { var g = d(this); return g[a] || (g[a] = new b(a)) } var d = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, b = function (a) { this.name = a; this.listeners = [] }; b.prototype = { getListenerIndex: function (a) { for (var b = 0, f = this.listeners; b < f.length; b++)if (f[b].fn == a) return b; return -1 } };
        return {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, f = 0, l = function () { f = 1 }; return function (h, k, p) {
                    var e = d(this)[h]; h = a; var z = f; a = f = 0; if (e) {
                        var w = e.listeners; if (w.length) for (var w = w.slice(0), y, G = 0; G < w.length; G++) {
                            if (e.errorProof) try {
                                y =
                                w[G].call(this, p, k, b, l)
                            } catch (q) { } else y = w[G].call(this, p, k, b, l); !1 === y ? f = 1 : "undefined" != typeof y && (k = y); if (a || f) break
                        }
                    } k = f ? !1 : "undefined" == typeof k ? !0 : k; a = h; f = z; return k
                }
            }(), fireOnce: function (a, b, f) { b = this.fire(a, b, f); delete d(this)[a]; return b }, removeListener: function (a, b) { var f = d(this)[a]; if (f) { var l = f.getListenerIndex(b); 0 <= l && f.listeners.splice(l, 1) } }, removeAllListeners: function () { var a = d(this), b; for (b in a) delete a[b] }, hasListeners: function (a) { return (a = d(this)[a]) && 0 < a.listeners.length }
        }
    }());
    ...
    (function () {
        function a(a, w, b) { this._minInterval = a; this._context = b; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(w, b || {}); var e = this; this.input = function () { function a() { e._lastOutput = (new Date).getTime(); e._scheduledTimer = 0; e._call() } if (!e._scheduledTimer || !1 !== e._reschedule()) { var z = (new Date).getTime() - e._lastOutput; z < e._minInterval ? e._scheduledTimer = setTimeout(a, e._minInterval - z) : a() } } } function d(z, b, e) {
            a.call(this, z, b, e); this._args = []; var c = this; this.input = CKEDITOR.tools.override(this.input,
                function (a) { return function () { c._args = Array.prototype.slice.call(arguments); a.call(this) } })
        } var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", g = /&/g, f = />/g, l = /</g, h = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, p = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, e = function (a, b) { return "#" == b[0] ? String.fromCharCode(parseInt(b.slice(1), 10)) : p[b] }; CKEDITOR.on("reset", function () { b = [] }); CKEDITOR.tools = {
            arrayCompare: function (a, b) {
            ...
            }, capitalize: function (a, b) { return a.charAt(0).toUpperCase() + (b ? a.slice(1) : a.slice(1).toLowerCase()) }, extend: function (a) { var b = arguments.length, e, c; "boolean" == typeof (e = arguments[b - 1]) ? b-- : "boolean" == typeof (e = arguments[b - 2]) && (c = arguments[b - 1], b -= 2); for (var h = 1; h < b; h++) { var n = arguments[h] || {}; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function (b) { if (!0 === e || null == a[b]) if (!c || b in c) a[b] = n[b] }) } return a }, prototypedCopy: function (a) {
                var b = function () { };
            ...
            }(), buildStyleHtml: function (a) { a = [].concat(a); for (var b, e = [], c = 0; c < a.length; c++)if (b = a[c]) /@import|[{}]/.test(b) ? e.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : e.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e'); return e.join("") }, htmlEncode: function (a) { return void 0 === a || null === a ? "" : String(a).replace(g, "\x26amp;").replace(f, "\x26gt;").replace(l, "\x26lt;") }, htmlDecode: function (a) {
                return a.replace(k,
                    e)
                ...
                var e = b == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")), c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div"; if (!e) { var n = /\n{2}/g; if (n.test(c)) var k = "\x3c" + h + "\x3e", d = "\x3c/" + h + "\x3e", c = k + c.replace(n, function () { return d + k }) + d } c = c.replace(/\n/g, "\x3cbr\x3e"); e || (c =
                    c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function (a) { return CKEDITOR.tools.repeat(a, 2) })); c = c.replace(/^ | $/g, "\x26nbsp;"); return c = c.replace(/(>|\s) /g, function (a, b) { return b + "\x26nbsp;" }).replace(/ (?=<)/g, "\x26nbsp;")
                ...
                b) { var e = b(a); e.prototype = a.prototype; return e }, setTimeout: function (a, b, e, c, h) { h || (h = window); e || (e = h); return h.setTimeout(function () { c ? a.apply(e, [].concat(c)) : a.apply(e) }, b || 0) }, throttle: function (a, b, e) { return new this.buffers.throttle(a, b, e) }, trim: function () { var a = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g; return function (b) { return b.replace(a, "") } }(), ltrim: function () { var a = /^[ \t\n\r]+/g; return function (b) { return b.replace(a, "") } }(), rtrim: function () {
                    ...
                    }(), repeat: function (a, b) { return Array(b + 1).join(a) }, tryThese: function () { for (var a, b = 0, e = arguments.length; b < e; b++) { var c = arguments[b]; try { a = c(); break } catch (h) { } } return a }, genKey: function () { return Array.prototype.slice.call(arguments).join("-") }, defer: function (a) {
                        return function () {
                    ...
                    }, _isValidColorFormat: function (a) { if (!a) return !1; a = a.replace(/\s+/g, ""); return /^[a-z0-9()#%,./]+$/i.test(a) }, parseCssText: function (a, b, e) {
                        var c = {}; e && (a = (new CKEDITOR.dom.element("span")).setAttribute("style", a).getAttribute("style") || ""); a && (a = CKEDITOR.tools.normalizeHex(CKEDITOR.tools.convertRgbToHex(a))); if (!a || ";" == a) return c; a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, e, z) {
                            b && (e =
                                e.toLowerCase(), "font-family" == e && (z = z.replace(/\s*,\s*/g, ",")), z = CKEDITOR.tools.trim(z)); c[e] = z
                        }); return c
            ...
            enableHtml5Elements: function (a, b) { for (var e = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = e.length, h; c--;)h = a.createElement(e[c]), b && a.appendChild(h) }, checkIfAnyArrayItemMatches: function (a, b) { for (var e = 0, c = a.length; e < c; ++e)if (a[e].match(b)) return !0; return !1 }, checkIfAnyObjectPropertyMatches: function (a, b) { for (var e in a) if (e.match(b)) return !0; return !1 }, keystrokeToString: function (a,
                b) { var e = this.keystrokeToArray(a, b); e.display = e.display.join("+"); e.aria = e.aria.join("+"); return e }, keystrokeToArray: function (a, b) { var e = b & 16711680, c = b & 65535, h = CKEDITOR.env.mac, n = [], k = []; e & CKEDITOR.CTRL && (n.push(h ? "⌘" : a[17]), k.push(h ? a[224] : a[17])); e & CKEDITOR.ALT && (n.push(h ? "⌥" : a[18]), k.push(a[18])); e & CKEDITOR.SHIFT && (n.push(h ? "⇧" : a[16]), k.push(a[16])); c && (a[c] ? (n.push(a[c]), k.push(a[c])) : (n.push(String.fromCharCode(c)), k.push(String.fromCharCode(c)))); return { display: n, aria: k } }, transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function (a) { a = a.toLowerCase(); for (var b = document.cookie.split(";"), e, c, h = 0; h < b.length; h++)if (e = b[h].split("\x3d"), c = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase()), c === a) return decodeURIComponent(1 < e.length ? e[1] : ""); return null }, setCookie: function (a, b) { document.cookie = encodeURIComponent(a) + "\x3d" + encodeURIComponent(b) + ";path\x3d/" }, getCsrfToken: function () {
                ...
                parse: {
                    ...
                    _rgbaRegExp: /rgba?\(\s*\d+%?\s*,\s*\d+%?\s*,\s*\d+%?\s*(?:,\s*[0-9.]+\s*)?\)/gi, _hslaRegExp: /hsla?\(\s*[0-9.]+\s*,\s*\d+%\s*,\s*\d+%\s*(?:,\s*[0-9.]+\s*)?\)/gi, background: function (a) { var b = {}, e = this._findColor(a); e.length && (b.color = e[0], CKEDITOR.tools.array.forEach(e, function (b) { a = a.replace(b, "") })); if (a = CKEDITOR.tools.trim(a)) b.unprocessed = a; return b }, margin: function (a) {
                        return CKEDITOR.tools.style.parse.sideShorthand(a, function (a) {
                            return a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset|revert)/g) ||
                                ["0px"]
                        })
                    }, sideShorthand: function (a, b) { function e(a) { c.top = h[a[0]]; c.right = h[a[1]]; c.bottom = h[a[2]]; c.left = h[a[3]] } var c = {}, h = b ? b(a) : a.split(/\s+/); switch (h.length) { case 1: e([0, 0, 0, 0]); break; case 2: e([0, 1, 0, 1]); break; case 3: e([0, 1, 2, 1]); break; case 4: e([0, 1, 2, 3]) }return c }, border: function (a) { return CKEDITOR.tools.style.border.fromCssRule(a) }, _findColor: function (a) {
                        var b = [], e = CKEDITOR.tools.array, b = b.concat(a.match(this._rgbaRegExp) || []), b = b.concat(a.match(this._hslaRegExp) || []); return b = b.concat(e.filter(a.split(/\s+/),
                            function (a) { return a.match(/^\#[a-f0-9]{3}(?:[a-f0-9]{3})?$/gi) ? !0 : a.toLowerCase() in CKEDITOR.tools.style.parse._colors }))
                    }
                }
            }, array: {
                filter: function (a, b, e) { var c = []; this.forEach(a, function (h, n) { b.call(e, h, n, a) && c.push(h) }); return c }, find: function (a, b, e) { for (var c = a.length, h = 0; h < c;) { if (b.call(e, a[h], h, a)) return a[h]; h++ } }, forEach: function (a, b, e) { var c = a.length, h; for (h = 0; h < c; h++)b.call(e, a[h], h, a) }, map: function (a, b, e) { for (var c = [], h = 0; h < a.length; h++)c.push(b.call(e, a[h], h, a)); return c }, reduce: function (a,
                ...
                entries: function (a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function (b) { return [b, a[b]] }) }, values: function (a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function (b) { return a[b] }) }, keys: function (a) {
                    var b = Object.prototype.hasOwnProperty, e = [], c = CKEDITOR.tools.object.DONT_ENUMS; if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) { b = []; if ("string" === typeof a) for (e = 0; e < a.length; e++)b.push(String(e)); return b } for (var h in a) e.push(h); if (CKEDITOR.env.ie &&
                        9 > CKEDITOR.env.version) for (h = 0; h < c.length; h++)b.call(a, c[h]) && e.push(c[h]); return e
                }, findKey: function (a, b) { if ("object" !== typeof a) return null; for (var e in a) if (a[e] === b) return e; return null }, merge: function (a, b) { var e = CKEDITOR.tools, c = e.clone(a), h = e.clone(b); e.array.forEach(e.object.keys(h), function (a) { c[a] = "object" === typeof h[a] && "object" === typeof c[a] ? e.object.merge(c[a], h[a]) : h[a] }); return c }
                ...
                } var c = CKEDITOR.tools.copy(b); e(a.getFrame()); var h = CKEDITOR.document.getWindow().getScrollPosition(); c.top += h.y; c.left += h.x; "x" in c && "y" in c && (c.y += h.y, c.x += h.x); c.right = c.left + c.width; c.bottom = c.top + c.height; return c
            }
        }; a.prototype = {
            ...
            $: function (a) { a = a || {}; this.width = a.width; this.style = a.style; this.color = a.color; this._.normalize() }, _: {
                ...
                fromCssRule: function (a) {
                    ...
                    b = b || {}; var e = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (e, c) { var h = a["border-" + c] || b[c]; e[c] = h ? CKEDITOR.tools.style.parse.sideShorthand(h) : null; return e }, {}); return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, c) {
                        var h = {}, k; for (k in e) {
                            var d =
                                a["border-" + c + "-" + k]; h[k] = d ? d : e[k] && e[k][c]
                        } b["border-" + c] = new CKEDITOR.tools.style.border(h); return b
                    }, {})
                }
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) { if (this.$.createStyleSheet) this.$.createStyleSheet(a); else { var d = new CKEDITOR.dom.element("link"); d.setAttributes({ rel: "stylesheet", type: "text/css", href: a }); this.getHead().append(d) } }, appendStyleText: function (a) {
            ...
            for (var b =
                this.$.documentElement, c = 0; b && c < a.length; c++) { var g = a[c]; if (d) for (var f = -1, l = 0; l < b.childNodes.length; l++) { var h = b.childNodes[l]; if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType) if (f++, f == g) { b = h; break } } else b = b.childNodes[g] } return b ? new CKEDITOR.dom.node(b) : null
            ...
            null !== String(g.add).match(/\[Native code\]/gi), f = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    var b = this.$.style; if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                        var c = ["top", "left", "right", "bottom"], e; "border" == a && (e = ["color", "style", "width"]); for (var b = [], d = 0; d < c.length; d++)if (e) for (var f =
                            0; f < e.length; f++)b.push([a, c[d], e[f]].join("-")); else b.push([a, c[d]].join("-")); for (a = 0; a < b.length; a++)this.removeStyle(b[a])
                    }
                    ...
                    var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), f = "BackCompat" == e.$.compatMode; if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        8 !== CKEDITOR.env.version : 1)) { var g = this.$.getBoundingClientRect(), l = e.$.documentElement, q = l.clientTop || d.$.clientTop || 0, n = l.clientLeft || d.$.clientLeft || 0, H = !0; CKEDITOR.env.ie && (H = e.getDocumentElement().contains(this), e = e.getBody().contains(this), H = f && e || !f && H); H && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || l.scrollLeft, c = d.$.scrollTop || l.scrollTop) : (c = f ? d.$ : l, b = c.scrollLeft, c = c.scrollTop), b = g.left + b - n, c = g.top + c - q) } else for (q = this, n = null; q && "body" != q.getName() &&
                            "html" != q.getName();) { b += q.$.offsetLeft - q.$.scrollLeft; c += q.$.offsetTop - q.$.scrollTop; q.equals(this) || (b += q.$.clientLeft || 0, c += q.$.clientTop || 0); for (; n && !n.equals(q);)b -= n.$.scrollLeft, c -= n.$.scrollTop, n = n.getParent(); n = q; q = (g = q.$.offsetParent) ? new CKEDITOR.dom.element(g) : null } a && (g = this.getWindow(), q = a.getWindow(), !g.equals(q) && g.$.frameElement && (a = (new CKEDITOR.dom.element(g.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y)); document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko ||
                                f || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0); return { x: b, y: c }
                    ...
                    CKEDITOR.env.webkit && (f = this.getEditor(!1)) && (f._.previousScrollTop = null); f = a.getWindow(); d = q(this, f); var x = q(a, f), I = this.$.offsetHeight; e = this.$.offsetWidth; var K = a.$.clientHeight, m = a.$.clientWidth; f = d.x - n(this, "left") - x.x || 0; g = d.y - n(this, "top") - x.y || 0; e = d.x + e + n(this, "right") - (x.x + m) || 0; d = d.y + I + n(this, "bottom") - (x.y + K) || 0; (0 > g || 0 < d) && l(0, !0 === b ? g : !1 === b ? d : 0 > g ? g : d); c && (0 > f || 0 < e) && l(0 > f ? f : e, 0)
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var e, d = c.startContainer; e = c.endContainer; var f = c.startOffset, g = c.endOffset, h, z = this.guard, m = this.type, l = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var M = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(), A = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(g) : e.getNext(); this._.guardLTR = function (a, b) {
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (e) { var d, f; d = e && e.type != CKEDITOR.NODE_ELEMENT && (f = e.getParent()) && c(f); d = a ? d : d || c(e); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (e) { b(e) ? e = 1 : (e.type == CKEDITOR.NODE_TEXT && (e = e.getParent()), e = e.$.offsetWidth <= c); return !!(a ^ e) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                function b(a) { return !f(a) && !l(a) } return function (c) {
                    var e = CKEDITOR.env.needsBrFiller ? c.is && c.is("br") : c.getText && g.test(c.getText()); e && (e = c.getParent(), c = c.getNext(b), e = e.isBlockBoundary() &&
                ...
                function (a) { return function (b) { b = f(b) || l(b) || h(b); return !!(a ^ b) } }; var p = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, e = b.getChildCount(); c < e; ++c)if (!p(b.getChild(c))) return !!a; return !a } }; var e = CKEDITOR.dom.walker.empty(), z = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        p(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(z) && e(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, f) {
            function g(a, b, c, e) { var C = c ? a.getPrevious() : a.getNext(); if (e && l) return C; k || e ? b.append(a.clone(!0, f), c) : (a.remove(), p && b.append(a, c)); return C } function n() { var a, b, c, e = Math.min(T.length, t.length); for (a = 0; a < e; a++)if (b = T[a], c = t[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = P - 1, c = E && D && !m.equals(F); b < J - 1 || b < v - 1 || c ? (c ? a.moveToPosition(F,
            ...
            } a.optimizeBookmark(); var l = 0 === b, p = 1 == b, k = 2 == b; b = k || p; var m = a.startContainer, F = a.endContainer,
                M = a.startOffset, A = a.endOffset, N, r, E, D, u, S; if (k && F.type == CKEDITOR.NODE_TEXT && (m.equals(F) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(F))) c.append(a.document.createText(F.substring(M, A))); else {
                    F.type == CKEDITOR.NODE_TEXT ? k ? S = !0 : F = F.split(A) : 0 < F.getChildCount() ? A >= F.getChildCount() ? (F = F.getChild(A - 1), r = !0) : F = F.getChild(A) : D = r = !0; m.type == CKEDITOR.NODE_TEXT ? k ? u = !0 : m.split(M) : 0 < m.getChildCount() ? 0 === M ? (m = m.getChild(M), N = !0) : m = m.getChild(M - 1) : E = N = !0; for (var T = m.getParents(), t = F.getParents(), P = n(),
        ...
        function g(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && p(a) && (b = a); return k(a) && !(l(a) && a.equals(b)) }) } } var f = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, l = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, k = CKEDITOR.dom.walker.editable(), p = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                } var c = this.startContainer, d = this.endContainer, f = this.collapsed, g, n, h, l; g = this.document.createElement("span"); g.data("cke-bookmark", 1); g.setStyle("display", "none"); g.setHtml("\x26nbsp;"); a && (h = "cke_bm_" + CKEDITOR.tools.getNextNumber(), g.setAttribute("id", h + (f ? "C" : "S"))); f || (n = g.clone(), n.setHtml("\x26nbsp;"), a && n.setAttribute("id", h + "E"), l = this.clone(), b(d) && (d = b(d),
                    l.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)), l.collapse(), l.insertNode(n)); l = this.clone(); b(c) && (d = b(c), l.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START)); l.collapse(!0); l.insertNode(g); n ? (this.setStartAfter(g), this.setEndBefore(n)) : this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END); return { startNode: a ? h + (f ? "C" : "S") : g, endNode: a ? h + "E" : n, serializable: a, collapsed: f }
            }, createBookmark2: function () {
                function a(b) {
                    var e = b.container, d = b.offset, f; f = e; var g = d; f = f.type != CKEDITOR.NODE_ELEMENT || 0 === g || g == f.getChildCount() ?
                        0 : f.getChild(g - 1).type == CKEDITOR.NODE_TEXT && f.getChild(g).type == CKEDITOR.NODE_TEXT; f && (e = e.getChild(d - 1), d = e.getLength()); if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: { for (f = e; d--;)if (g = f.getChild(d).getIndex(!0), 0 <= g) { d = g; break a } d = -1 } d += 1 } if (e.type == CKEDITOR.NODE_TEXT) {
                            f = e; for (g = 0; (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;)g += f.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length; f = g; e.isEmpty() ? (g = e.getPrevious(c), f ? (d = f, e = g ? g.getNext() : e.getParent().getFirst()) : (e = e.getParent(),
                    ...
                    var d = this.collapsed, f = { container: this.startContainer, offset: this.startOffset }, n = { container: this.endContainer, offset: this.endOffset }; c && (a(f), b(f, this.root),
                        d || (a(n), b(n, this.root))); return { start: f.container.getAddress(c), end: d ? null : n.container.getAddress(c), startOffset: f.offset, endOffset: n.offset, normalized: c, collapsed: d, is2: !0 }
                }
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    case CKEDITOR.ENLARGE_INLINE: var f = 1; case CKEDITOR.ENLARGE_ELEMENT: var g = function (a, b) {
                        var c = new CKEDITOR.dom.range(h); c.setStart(a, b); c.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); var c = new CKEDITOR.dom.walker(c), e; for (c.guard =
                    ...
                    }; if (this.collapsed) break; var n = this.getCommonAncestor(), h = this.root, l, p, k, m, F, M = !1, A, N; A = this.startContainer; var r = this.startOffset; A.type == CKEDITOR.NODE_TEXT ? (r && (A = !CKEDITOR.tools.trim(A.substring(0, r)).length && A, M = !!A), A && ((m = A.getPrevious()) || (k = A.getParent()))) : (r && (m = A.getChild(r - 1) || A.getLast()), m || (k = A));
                        for (k = c(k); k || m;) {
                            if (k && !m) { !F && k.equals(n) && (F = !0); if (f ? k.isBlockBoundary() : !h.contains(k)) break; M && "inline" == k.getComputedStyle("display") || (M = !1, F ? l = k : this.setStartBefore(k)); m = k.getPrevious() } for (; m;)if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
                                if (m.type == CKEDITOR.NODE_TEXT) N = m.getText(), d.test(N) && (m = null), A = /[\s\ufeff]$/.test(N); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (M && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                    N = m.getText();
                                    if (d.test(N)) m = null; else for (var r = m.$.getElementsByTagName("*"), E = 0, D; D = r[E++];)if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) { m = null; break } m && (A = !!N.length)
                                } else m = null; A && (M ? F ? l = k : k && this.setStartBefore(k) : M = !0); if (m) { A = m.getPrevious(); if (!k && !A) { k = m; m = null; break } m = A } else k = null
                            } k && (k = c(k.getParent()))
                        } A = this.endContainer; r = this.endOffset; k = m = null; F = M = !1; A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(r)).length ? M = !0 : (M = !A.getLength(), r == A.getLength() ? (m = A.getNext()) || (k = A.getParent()) :
                            g(A, r) && (k = A.getParent())) : (m = A.getChild(r)) || (k = A); for (; k || m;) {
                                if (k && !m) { !F && k.equals(n) && (F = !0); if (f ? k.isBlockBoundary() : !h.contains(k)) break; M && "inline" == k.getComputedStyle("display") || (M = !1, F ? p = k : k && this.setEndAfter(k)); m = k.getNext() } for (; m;) {
                                    A = !1; if (m.type == CKEDITOR.NODE_TEXT) N = m.getText(), g(m, 0) || (m = null), A = /^[\s\ufeff]/.test(N); else if (m.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (M && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            N = m.getText(); if (d.test(N)) m =
                                                null; else for (r = m.$.getElementsByTagName("*"), E = 0; D = r[E++];)if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) { m = null; break } m && (A = !!N.length)
                                        } else m = null
                                    } else A = 1; A && M && (F ? p = k : this.setEndAfter(k)); if (m) { A = m.getNext(); if (!k && !A) { k = m; m = null; break } m = A } else k = null
                                } k && (k = c(k.getParent()))
                                ...
                                CKEDITOR.POSITION_AFTER_START); k.setEnd(this.startContainer, this.startOffset); k = new CKEDITOR.dom.walker(k); var u, S, T = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), t = null, P = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (t) { if (t.equals(a)) { t = null; return } } else t = a; else if (t) return; var b = T(a); b || (u = a); return b }, f = function (a) { var b = P(a); !b && a.is && a.is("br") && (S = a); return b }; k.guard = P; k = k.lastBackward(); u = u || h; this.setStartAt(u,
                                    !u.is("br") && (!k && this.checkStartOfBlock() || k && u.contains(k)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { k = this.clone(); k = new CKEDITOR.dom.walker(k); var J = CKEDITOR.dom.walker.whitespaces(), v = CKEDITOR.dom.walker.bookmark(); k.evaluator = function (a) { return !J(a) && !v(a) }; if ((k = k.previous()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("br")) break } k = this.clone(); k.collapse(); k.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); k = new CKEDITOR.dom.walker(k); k.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : P; u = t = S = null; k = k.lastForward(); u = u || h; this.setEndAt(u, !k && this.checkEndOfBlock() || k && u.contains(k) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); S && this.setEndAfter(S)
                }
                ...
                b) { var c = this.createBookmark(), d = this.document.createElement(b); this.collapse(a); this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS); this.extractContents().appendTo(d); d.trim(); this.insertNode(d); var f = d.getBogus(); f && f.remove(); d.appendBogus(); this.moveToBookmark(c); return d }, splitBlock: function (a, b) {
                    var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, g = d.block, n = null; if (!c.blockLimit.equals(d.blockLimit)) return null; "br" !=
                        a && (f || (f = this.fixBlock(!0, a), g = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), g || (g = this.fixBlock(!1, a))); c = f && this.checkStartOfBlock(); d = g && this.checkEndOfBlock(); this.deleteContents(); f && f.equals(g) && (d ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END), g = null) : c ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (g = this.splitElement(f, b ||
                            !1), f.is("ul", "ol") || f.appendBogus())); return { previousBlock: f, nextBlock: g, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n }
                    ...
                    } var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.dom.walker.bookmark(!1); return function (b) { for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), f = d.block || d.blockLimit, g; f && !f.equals(d.root) && !f.getFirst(a(f));)g = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = g; this.moveToBookmark(c) }
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
                        !0; for (var c = 0; a;) {
                            ...
                            else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block)) return this.setStartBefore(a), this.setEndAfter(a), !0; var d = a, f = c, g = void 0; d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (g = d[b ? "getLast" : "getFirst"](p)); f || g || (g = d[b ? "getPrevious" : "getNext"](p)); a = g
                        } return !!c
                }, moveToClosestEditablePosition: function (a, b) {
                    var c, d = 0, f, g, n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START]; a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, n[b ? 0 : 1])) : c = this.clone(); if (a &&
                        !a.is(CKEDITOR.dtd.$block)) d = 1; else if (f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (g = f.type == CKEDITOR.NODE_ELEMENT) && f.is(CKEDITOR.dtd.$block) && "false" == f.getAttribute("contenteditable") ? (c.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && g && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(f, 0), c.collapse()) : c.moveToPosition(f, n[b ? 1 : 0]); d && this.moveToRange(c); return !!d
            ...
            moveToElementEditEnd: function (a) { return this.moveToElementEditablePosition(a, !0) }, getEnclosedNode: function () { var a = this.clone(); a.optimize(); if (a.startContainer.type != CKEDITOR.NODE_ELEMENT || a.endContainer.type != CKEDITOR.NODE_ELEMENT) return null; var a = new CKEDITOR.dom.walker(a), b = CKEDITOR.dom.walker.bookmark(!1, !0), c = CKEDITOR.dom.walker.whitespaces(!0); a.evaluator = function (a) { return c(a) && b(a) }; var d = a.next(); a.reset(); return d && d.equals(a.previous()) ? d : null }, getTouchedStartNode: function () {
                ...
                function a(b, c) {
                    ...
                    var f = this.root.getDocument().$.createRange(), g; f.setStart(this.startContainer.$, this.startOffset); f.setEnd(this.endContainer.$, this.endOffset); g = f.getClientRects(); g = a(g, this); g.length || (g = b(g, f, this)); return CKEDITOR.tools.array.map(g, function (a) {
                        return c(a,
                            d, this)
                    }, this)
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], g, n, h, l; if (c && c.find) for (n = c.find(a), g = 0; g < n.count(); g++)if (c = n.getItem(g), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
                    d.endNode.equals(c), h && l && f.push(c); return f
            }
    ...
    (function () {
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, f, g) {
            ...
            h = function (a) { return f(a) && l(a) }, k = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, l, w, y, G; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var q = this.range.clone(); l = q.startPath(); var n = q.endPath(), H = !q.collapsed && c(q, l.block), x = !q.collapsed && c(q, n.block, 1); q.shrink(CKEDITOR.SHRINK_ELEMENT, !0); H && q.setStartAt(l.block, CKEDITOR.POSITION_BEFORE_END); x && q.setEndAt(n.block, CKEDITOR.POSITION_AFTER_START); l = q.endContainer.hasAscendant("pre", !0) || q.startContainer.hasAscendant("pre", !0); q.enlarge(this.forceBrBreak && !l || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                        q.collapsed || (l = new CKEDITOR.dom.walker(q.clone()), n = CKEDITOR.dom.walker.bookmark(!0, !0), l.evaluator = n, this._.nextNode = l.next(), l = new CKEDITOR.dom.walker(q.clone()), l.evaluator = n, l = l.previous(), this._.lastNode = l.getNextSourceNode(!0, null, q.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (n = this.range.clone(), n.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), n.checkEndOfBlock() &&
                            (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && q.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = q.document.createText(""), this._.lastNode.insertAfter(l)), q = null); this._.started = 1; l = q
                    } n = this._.nextNode; q = this._.lastNode; for (this._.nextNode = null; n;) {
                        var H = 0, x = n.hasAscendant("pre"), I = n.type != CKEDITOR.NODE_ELEMENT, K = 0; if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0); else {
                            var m = n.getName();
                            if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) { d = n; b(this, a, d); break } else if (n.isBlockBoundary(this.forceBrBreak && !x && { br: 1 })) { if ("br" == m) I = 1; else if (!l && !n.getChildCount() && "hr" != m) { d = n; w = n.equals(q); break } l && (l.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), "br" != m && (this._.nextNode = n)); H = 1 } else { if (n.getFirst()) { l || (l = this.range.clone(), l.setStartAt(n, CKEDITOR.POSITION_BEFORE_START)); n = n.getFirst(); continue } I = 1 }
                        } I && !l && (l = this.range.clone(), l.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                        w = (!H || I) && n.equals(q); if (l && !H) for (; !n.getNext(h) && !w;) { m = n.getParent(); if (m.isBlockBoundary(this.forceBrBreak && !x && { br: 1 })) { H = 1; I = 0; w || m.equals(q); l.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); break } n = m; I = 1; w = n.equals(q); K = 1 } I && l.setEndAt(n, CKEDITOR.POSITION_AFTER_END); n = this._getNextSourceNode(n, K, q); if ((w = !n) || H && l) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, f) {
            var e, g; a = []; for (e in b) {
                g = b[e]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : E(g); "$" != e.charAt(0) && (g.elements = e); c && (g.featureName = c.toLowerCase()); var m = g; m.elements = l(m.elements, /\s+/) || null; m.propertiesOnly = m.propertiesOnly || !0 === m.elements; var v = /\s*,\s*/, r = void 0; for (r in S) {
                    m[r] = l(m[r], v) || null; var D = m, t = T[r], n = l(m[T[r]], v), h = m[r], u = [], B = !0, P = void 0; n ? B = !1 : n = {}; for (P in h) "!" == P.charAt(0) && (P = P.slice(1), u.push(P), n[P] = !0, B = !1); for (; P = u.pop();)h[P] =
                        h["!" + P], delete h["!" + P]; D[t] = (B ? !1 : n) || null
                } m.match = m.match || null; d.push(g); a.push(g)
            } b = f.elements; f = f.generic; var F; c = 0; for (d = a.length; c < d; ++c) {
                e = E(a[c]); g = !0 === e.classes || !0 === e.styles || !0 === e.attributes; m = e; r = t = v = void 0; for (v in S) m[v] = H(m[v]); D = !0; for (r in T) { v = T[r]; t = m[v]; n = []; h = void 0; for (h in t) -1 < h.indexOf("*") ? n.push(new RegExp("^" + h.replace(/\*/g, ".*") + "$")) : n.push(h); t = n; t.length && (m[v] = t, D = !1) } m.nothingRequired = D; m.noProperties = !(m.attributes || m.classes || m.styles); if (!0 === e.elements ||
                    null === e.elements) f[g ? "unshift" : "push"](e); else for (F in m = e.elements, delete e.elements, m) if (b[F]) b[F][g ? "unshift" : "push"](e); else b[F] = [e]
            }
        } function d(a, c, d, f) {
            if (!a.match || a.match(c)) if (f || h(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, f; for (f in b) if (d || a(f)) delete b[f], c = !0; return c } function f(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function l(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = D(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, f; for (f in a) c[f] = a[f], d++; return d ? c : !1 } function h(a, b) {
                if (a.nothingRequired) return !0;
                var c, d, f, e; if (f = a.requiredClasses) for (e = b.classes, c = 0; c < f.length; ++c)if (d = f[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(e, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(e, d)) return !1; return k(b.styles, a.requiredStyles) && k(b.attributes, a.requiredAttributes)
            ...
            } function e(a) { var b, c, d, f, e = {}, g = 1; for (a = D(a); b = a.match(t);)(c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + g++] = { elements: b[1], classes: c, styles: d, attributes: f }, a = a.slice(b[0].length); return e } function z(a, b) { var c = a.match(P[b]); return c ? D(c[1]) : null } function w(a) {
                ...
                var g = 0, r; e.toHtml && (b.name = b.name.replace(J, "$1")); if (e.doCallbacks && a.elementCallbacks) { a: { r = a.elementCallbacks; for (var t = 0, D = r.length, h; t < D; ++t)if (h = r[t](b)) { r = h; break a } r = void 0 } if (r) return r } if (e.doTransform && (r = a._.transformations[b.name])) { w(b); for (t = 0; t < r.length; ++t)m(a, b, r[t]); q(b) } if (e.doFilter) {
                    a: {
                    ...
                    r = a.validClasses; var t = b.attributes, B = b.styles, D = b.classes; h = b.classBackup; var F = b.styleBackup, k, A, M = [], l = [], N = /^data-cke-/; u = !1; delete t.style; delete t["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (k in t) E[k] || (N.test(k) ? k == (A = k.replace(/^data-cke-saved-/, "")) || E[A] || (delete t[k], u = !0) : (delete t[k], u = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (k in B) a.allStyles || P[k] ? M.push(k + ":" + B[k]) : u = !0; M.length && (t.style = M.sort().join("; ")) } else F && (t.style = F); if (!a.allClasses ||
                        a.hadInvalidClass) { for (k = 0; k < D.length; ++k)(a.allClasses || r[D[k]]) && l.push(D[k]); l.length && (t["class"] = l.sort().join(" ")); h && l.length < h.split(/\s+/).length && (u = !0) } else h && (t["class"] = h); u && (g = 1); if (!e.skipFinalValidation && !n(b)) return f.push(b), 1
                } e.toHtml && (b.name = b.name.replace(v, "cke:$1")); return g
            } function G(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function q(a) {
            ...
            } function n(a) { switch (a.name) { case "a": if (!(a.children.length || a.attributes.name || a.attributes.id)) return !1; break; case "img": if (!a.attributes.src) return !1 }return !0 } function H(a) { if (!a) return !1; if (!0 === a) return !0; var b = G(a); return function (c) { return c in a || b && c.match(b) } } function x() { return new CKEDITOR.htmlParser.element("br") } function I(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                    a.name || r.$block[a.name])
            } function K(a, b, c) {
                var d = a.name; if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(x()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !I(a.previous) && (b = x(), b.insertBefore(a)), a.next && !I(a.next) && (b = x(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var d = a.children, f; b: { f = r[b]; for (var e = 0, g = d.length, m; e < g; ++e)if (m = d[e], m.type == CKEDITOR.NODE_ELEMENT && !f[m.name]) { f = !1; break b } f = !0 } if (f) a.name = b, a.attributes =
            ...
            } function m(a, b, c) { var d, f; for (d = 0; d < c.length; ++d)if (f = c[d], !(f.check && !a.check(f.check, !1) || f.left && !f.left(b))) { f.right(b, B); break } } function F(a, b) {
                var c = b.getDefinition(), d = c.attributes, f = c.styles, e, g, m, v; if (a.name != c.element) return !1; for (e in d) if ("class" == e) for (c = d[e].split(/\s+/), m = a.classes.join("|"); v = c.pop();) { if (-1 == m.indexOf(v)) return !1 } else if (a.attributes[e] != d[e]) return !1; for (g in f) if (a.styles[g] !=
                    f[g]) return !1; return !0
                ...
                allow: function (b, c, d) {
                    if (!f(this, b, d)) return !1; var g, m; if ("string" == typeof b) b = e(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    } else if (CKEDITOR.tools.isArray(b)) { for (g = 0; g < b.length; ++g)m = this.allow(b[g], c, d); return m } a(this, b, c, this.allowedContent, this._.allowedRules); return !0
                    ...
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (m = y(f, a, e, t), m & 1) v = !0; else if (m & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var r, D, h; if (g) for (D = 0; D < g.length; ++D)if ((h = d.match(g[D])) && h[0].length == d.length) {
                                    c =
                                    !0; break a
                    ...
                    }, null, !0); e.length && (v = !0); var D; a = []; d = u[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var h; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? K(c, d, a) : c.remove(); for (; D = a.pop();)if (c = D.el, c.parent) switch (h = r[c.parent.name] || r.span, D.check) {
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], f; for (b = 0; b < a.length && !f; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (f = c); if (f) { for (b = 0; b < a.length; ++b)d.push(M(a[b], f)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, f; for (f = 0; f < a.length; ++f) {
                            b = a[f]; var e = void 0, g = void 0, m = void 0, v = void 0, t = void 0, r = void 0; c = []; for (g = 0; g < b.length; ++g)m = b[g], "string" == typeof m ? (m = m.split(/\s*:\s*/), v = m[0], t = null, r = m[1]) : (v = m.check, t = m.left, r = m.right), e || (e = m, e = e.element ? e.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                                e.left.getDefinition().element), t instanceof CKEDITOR.style && (t = A(t)), c.push({ check: v == e ? null : v, left: t, right: "string" == typeof r ? N(r) : r }); b = e; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                }, check: function (a, b, c) {
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var f, g; if ("string" == typeof a) {
                        g = a + "\x3c" + (!1 === b ? "0" : "1") + (c ? "1" : "0") + "\x3e"; if (g in this._.cachedChecks) return this._.cachedChecks[g]; f = e(a).$1; var v = f.styles, d = f.classes; f.name = f.elements;
                        f.classes = d = d ? d.split(/\s*,\s*/) : []; f.styles = p(v); f.attributes = p(f.attributes); f.children = []; d.length && (f.attributes["class"] = d.join(" ")); v && (f.attributes.style = CKEDITOR.tools.writeCssText(f.styles))
                    } else f = a.getDefinition(), v = f.styles, d = f.attributes || {}, v && !CKEDITOR.tools.isEmpty(v) ? (v = E(v), d.style = CKEDITOR.tools.writeCssText(v, !0)) : v = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: v, children: [] }; var v = CKEDITOR.tools.clone(f), t = [], r; if (!1 !== b && (r = this._.transformations[f.name])) {
                        for (d =
                            0; d < r.length; ++d)m(this, f, r[d]); q(f)
                    } y(this, v, t, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < t.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, v.attributes, !0), b && (f.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[g] = c); return c
                }, getAllowedEnterMode: function () {
                    var a = ["p", "div", "br"], b = { p: CKEDITOR.ENTER_P, div: CKEDITOR.ENTER_DIV, br: CKEDITOR.ENTER_BR };
                    return function (c, d) { var f = a.slice(), e; if (this.check(u[c])) return c; for (d || (f = f.reverse()); e = f.pop();)if (this.check(e)) return b[e]; return CKEDITOR.ENTER_BR }
            ...
            }; var S = { styles: 1, attributes: 1, classes: 1 }, T = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, t = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, P = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, J = /^cke:(object|embed|param)$/, v = /^(object|embed|param)$/, B; B = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, f = c.attributes, e, g, m, v; a.name = c.element; for (e in f) if ("class" ==
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, g, f) {
                var l = "string" == typeof b; l && (b = [b]); g || (g = CKEDITOR); var h = b.length, k = h, p = [], e = [], z = function (a) { c && (l ? c.call(g, a) : c.call(g, p, e)) }; if (0 === k) z(!0); else {
                    var w = function (a, b) { (b ? p : e).push(a); 0 >= --k && (f && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), z(b)) }, y = function (b, c) { a[b] = 1; var f = d[b]; delete d[b]; for (var e = 0; e < f.length; e++)f[e](b, c) }, G = function (b) {
                        if (a[b]) w(b, !0); else {
                            var f = d[b] || (d[b] = []); f.push(w); if (!(1 < f.length)) {
                                var e =
                                    new CKEDITOR.dom.element("script"); e.setAttributes({ type: "text/javascript", src: b }); c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function () { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, y(b, !0) } : (e.$.onload = function () { setTimeout(function () { e.$.onload = null; e.$.onerror = null; y(b, !0) }, 0) }, e.$.onerror = function () { e.$.onload = null; e.$.onerror = null; y(b, !1) })); e.appendTo(CKEDITOR.document.getHead())
                            }
                        }
                    }; f && CKEDITOR.document.getDocumentElement().setStyle("cursor",
                        "wait"); for (var q = 0; q < h; q++)G(b[q])
                }
            }, queue: function () { function a() { var b; (b = c[0]) && this.load(b.scriptUrl, b.callback, CKEDITOR, 0) } var c = []; return function (d, f) { var l = this; c.push({ scriptUrl: d, callback: function () { f && f.apply(this, arguments); c.shift(); a.call(l) } }); 1 == c.length && a.call(this) } }()
        }
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, g = this.registered, f = [], l = {}, h = {}, k = 0; k < a.length; k++) { var p = a[k]; if (p) if (c[p] || g[p]) h[p] = this.get(p); else { var e = this.getFilePath(p); f.push(e); e in l || (l[e] = []); l[e].push(p) } } CKEDITOR.scriptLoader.load(f,
                function (a, f) { if (f.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + l[f[0]].join(",") + '" was not found at "' + f[0] + '".'); for (var e = 0; e < a.length; e++)for (var g = l[a[e]], k = 0; k < g.length; k++) { var n = g[k]; h[n] = this.get(n); c[n] = 1 } d.call(b, h) }, this)
        }
        ...
        var d = {}; return function (b, c, g) {
            var f = {}, l = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(f, a); var b = [], e; for (e in a) {
                        var h = a[e], w = h && h.requires; if (!d[e]) { if (h.icons) for (var y = h.icons.split(","), G = y.length; G--;)CKEDITOR.skin.addIcon(y[G], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + y[G] + ".png"); h.isSupportedEnvironment = h.isSupportedEnvironment || function () { return !0 }; d[e] = 1 } if (w) for (w.split && (w =
                            w.split(",")), h = 0; h < w.length; h++)f[w[h]] || b.push(w[h])
                    } if (b.length) l.call(this, b); else { for (e in f) h = f[e], h.onLoad && !h.onLoad._called && (!1 === h.onLoad() && delete f[e], h.onLoad._called = 1); c && c.call(g || window, f) }
                }, this)
            }; l.call(this, b)
        }
    ...
    (function () {
        ...
        function k(a) { CKEDITOR.skin.loadPart("editor", function () { p(a) }) } function p(a) { CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) { var d = a.config.title; a.langCode = b; a.lang = CKEDITOR.tools.prototypedCopy(c); a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor, a.name].join(", "); a.config.contentsLangDirection || (a.config.contentsLangDirection = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.getDirection(1) : a.lang.dir); a.fire("langLoaded"); e(a) }) } function e(a) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), f = b(c.extraPlugins), e = b(c.removePlugins); if (f) var g = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""), d = d + ("," + f); if (e) var h = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    var d = [], f = [], e = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        var m = b[g], l = m.lang, k = null, t = m.requires, P; CKEDITOR.tools.isArray(t) && (t = t.join(",")); if (t && (P = t.match(h))) for (; t = P.pop();)CKEDITOR.error("editor-plugin-required", { plugin: t.replace(",", ""), requiredBy: g }); l && !a.lang[g] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, k) ? k : 0 <= CKEDITOR.tools.indexOf(l,
                            "en") ? "en" : l[0]), m.langEntries && m.langEntries[k] ? (a.lang[g] = m.langEntries[k], k = null) : e.push(CKEDITOR.getUrl(m.path + "lang/" + k + ".js"))); f.push(k); d.push(m)
                    } CKEDITOR.scriptLoader.load(e, function () {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], e = 0; e < b.length; e++)for (var g = 0; g < d.length; g++) { var m = d[g]; 0 === e && f[g] && m.lang && m.langEntries && (a.lang[m.name] = m.langEntries[f[g]]); if (m[b[e]]) m[b[e]](a) } a.fireOnce("pluginsLoaded"); c.keystrokes && a.setKeystroke(a.config.keystrokes);
        ...
        } function w() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData(); this.config.htmlEncodeOutput && (b = CKEDITOR.tools.htmlEncode(b)); a.is("textarea") ? a.setValue(b) : a.setHtml(b); return !0 } return !1 } function y(a, b) {
            function c(a) {
                var b = a.startContainer, d = a.endContainer;
                return b.is && (b.is("tr") || b.is("td") && b.equals(d) && a.endOffset === b.getChildCount()) ? !0 : !1
            } function d(a) { var b = a.startContainer; return b.is("tr") ? a.cloneContents() : b.clone(!0) } for (var f = new CKEDITOR.dom.documentFragment, e, g, h, l = 0; l < a.length; l++) {
                var k = a[l], r = k.startContainer.getAscendant("tr", !0); c(k) ? (e || (e = r.getAscendant("table").clone(), e.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), f.append(e), e = e.findOne("thead, tbody, tfoot")), g && g.equals(r) || (g = r, h = r.clone(), e.append(h)), h.append(d(k))) :
                    f.append(k.cloneContents())
            } return e ? f : b.getHtmlFromRange(a[0])
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var G = 0, q = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            }, insertText: function (a) { this.fire("insertText", a) }, insertElement: function (a) { this.fire("insertElement", a) }, getSelectedHtml: function (a) { var b = this.editable(), c = this.getSelection(), c = c && c.getRanges(); if (!b || !c || 0 === c.length) return null; b = y(c, b); return a ? b.getHtml() : b }, extractSelectedHtml: function (a, b) {
            ...
            }, getCommandKeystroke: function (a, b) { var c = "string" === typeof a ? this.getCommand(a) : a, d = []; if (c) { var f = CKEDITOR.tools.object.findKey(this.commands, c), e = this.keystrokeHandler.keystrokes; if (c.fakeKeystroke) d.push(c.fakeKeystroke); else for (var g in e) e[g] === f && d.push(g) } return b ? d : d[0] || null }, addFeature: function (a) { return this.filter.addFeature(a) }, setActiveFilter: function (a) {
        ...
        var a = /([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g, d = { checked: 1, compact: 1, declare: 1, defer: 1, disabled: 1, ismap: 1, multiple: 1, nohref: 1, noresize: 1, noshade: 1, nowrap: 1, readonly: 1, selected: 1 }; CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () { }, onTagClose: function () { }, onText: function () { }, onCDATA: function () { }, onComment: function () { }, parse: function (b) {
                for (var c, g, f = 0, l; c = this._.htmlPartsRegex.exec(b);) {
                    g = c.index; if (g > f) if (f = b.substring(f, g), l) l.push(f); else this.onText(f);
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), g = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (f, l, h) {
                function k(a) { var b; if (0 < n.length) for (var c = 0; c < n.length; c++) { var d = n[c], f = d.name, e = CKEDITOR.dtd[f], g = x.name && CKEDITOR.dtd[x.name]; g && !g[f] || a && e && !e[a] && CKEDITOR.dtd[a] ? f == x.name && (z(x, x.parent, 1), c--) : (b || (p(), b = 1), d = d.clone(), d.parent = x, x = d, n.splice(c, 1), c--) } } function p() { for (; H.length;)z(H.shift(), x) } function e(a) {
                ...
                } function z(b, c, d) { c = c || x || q; var f = x; void 0 === b.previous && (w(c, b) && (x = c, G.onTagOpen(h, {}), b.returnPoint = c = x), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (K = !1), "textarea" == b.name && (I = !1)); b.returnPoint ? (x = b.returnPoint, delete b.returnPoint) : x = d ? c : f } function w(a, b) {
                ...
                } function y(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var G = new CKEDITOR.htmlParser, q = l instanceof CKEDITOR.htmlParser.element ? l : "string" == typeof l ? new CKEDITOR.htmlParser.element(l) : new CKEDITOR.htmlParser.fragment, n = [], H = [], x = q, I = "textarea" == q.name, K = "pre" == q.name; G.onTagOpen = function (f, e, g, h) {
                    e = new CKEDITOR.htmlParser.element(f, e); e.isUnknown && g && (e.isEmpty = !0); e.isOptionalClose = h;
                    if (a(e)) n.push(e); else {
                        if ("pre" == f) K = !0; else { if ("br" == f && K) { x.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (I = !0) } if ("br" == f) H.push(e); else {
                            for (; !(h = (g = x.name) ? CKEDITOR.dtd[g] || (x._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || x.isUnknown || h[f]);)if (x.isOptionalClose) G.onTagClose(g); else if (f in b && g in b) g = x.children, (g = g[g.length - 1]) && "li" == g.name || z(g = new CKEDITOR.htmlParser.element("li"), x), !e.returnPoint && (e.returnPoint = x), x = g; else if (f in CKEDITOR.dtd.$listItem &&
                                !y(f, g)) G.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (g in d && !y(f, g)) !e.returnPoint && (e.returnPoint = x), x = x.parent; else if (g in CKEDITOR.dtd.$inline && n.unshift(x), x.parent) z(x, x.parent, 1); else { e.isOrphan = 1; break } k(f); p(); e.parent = x; e.isEmpty ? z(e) : x = e
                        }
                    }
                }; G.onTagClose = function (a) {
                    for (var b = n.length - 1; 0 <= b; b--)if (a == n[b].name) { n.splice(b, 1); return } for (var c = [], d = [], f = x; f != q && f.name != a;)f._.isBlockLike || d.unshift(f), c.push(f), f = f.returnPoint || f.parent; if (f != q) {
                        for (b = 0; b < c.length; b++) { var e = c[b]; z(e, e.parent) } x =
                            f; f._.isBlockLike && p(); z(f, f.parent); f == x && (x = x.parent); n = n.concat(d)
                    } "body" == a && (h = !1)
                }; G.onText = function (a) { if (!(x._.hasInlineStarted && !H.length || K || I) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = x.name, f = b ? CKEDITOR.dtd[b] || (x._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!I && !f["#"] && b in d) G.onTagOpen(g[b] || ""), G.onText(a); else { p(); k(); K || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (w(x, a)) this.onTagOpen(h, {}, 0, 1); x.add(a) } }; G.onCDATA =
                    function (a) { x.add(new CKEDITOR.htmlParser.cdata(a)) }; G.onComment = function (a) { p(); k(); x.add(new CKEDITOR.htmlParser.comment(a)) }; G.parse(f); for (p(); x != q;)z(x, x.parent, 1); e(q); return q
    ...
    (function () {
        function a() { this.rules = [] } function d(b, c, d, f) { var l, h; for (l in c) (h = b[l]) || (h = b[l] = new a), h.add(c[l], d, f) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var f = [this.findIndex(c), 0], l = 0, h = a.length; l < h; l++)f.push({ value: a[l], priority: c, options: d }); this.rules.splice.apply(this.rules, f) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, f = Array.prototype.slice.call(arguments, 1), l = this.rules, h = l.length, k, p, e, z; for (z = 0; z < h; z++)if (d && (k = c.type, p = c.name), e = l[z], !(a.nonEditable && !e.options.applyToAll ||
                        a.nestedEditable && e.options.excludeNestedEditable)) { e = e.value.apply(null, f); if (!1 === e || d && e && (e.name != p || e.type != k)) return e; null != e && (f[0] = c = e) } return c
                }, execOnName: function (a, c) { for (var d = 0, f = this.rules, l = f.length, h; c && d < l; d++)h = f[d], a.nonEditable && !h.options.applyToAll || a.nestedEditable && h.options.excludeNestedEditable || (c = c.replace(h.value[0], h.value[1])); return c }
        }
    })();
    (function () {
        function a(a, d) {
            function e(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function t(a, d) {
                return function (g) {
                    if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var v = [], m = b(g), t, D; if (m) for (r(m, 1) && v.push(m); m;)f(m) && (t = c(m)) && r(t) && ((D = c(t)) && !f(D) ? v.push(t) : (e(h).insertAfter(t), t.remove())), m = m.previous; for (m = 0; m < v.length; m++)v[m].remove(); if (v = !a || !1 !== ("function" == typeof d ? d(g) : d)) h || CKEDITOR.env.needsBrFiller ||
                            g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? h || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem) ? (v = b(g), v = !v || "form" == g.name && "input" == v.name) : v = !1 : v = !1; v && g.add(e(a))
                    }
                }
            } function r(a, b) {
            ...
            } var D = { elements: {} }, h = "html" == d, u = CKEDITOR.tools.extend({}, m), E; for (E in u) "#" in I[E] || delete u[E]; for (E in u) D.elements[E] = t(h, a.config.fillEmptyBlocks); D.root = t(h, !1); D.elements.br = function (a) {
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var d = b.attributes; if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && g(d);)d =
                                d.next; var v = c(b); !d && f(b.parent) ? l(b.parent, e(a)) : f(d) && v && !f(v) && e(a).insertBefore(d)
                        }
                    }
                }
            }(h); return D
            ...
            return a.replace(r,
                function (a, b, c) { return "\x3c" + b + c.replace(E, function (a, b) { return D.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        } function e(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + y(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function z(a) { return a.replace(T, function (a, b) { return decodeURIComponent(b) }) } function w(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + x + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function y(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function G(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function q(a, b) {
            var c = [], d = b.config.protectedSource, f = b._.dataStore || (b._.dataStore =
                ...
                }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { f[f.id] = decodeURIComponent(b); return "{cke_protected_" + f.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, f) { return "\x3c" + c + d + "\x3e" + G(y(f), b) + "\x3c/" + c + "\x3e" })
            ...
            f, g = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = f = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(F); c.addRules(M, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); f.addRules(A); f.addRules(N, { applyToAll: !0 }); f.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, f, c = n(c), c = q(c, b), c = e(c, S), c = p(c), c = e(c, u), c = c.replace(t, "$1cke:$2"), c = c.replace(J, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2"); f = a.context || b.editable().getName(); var g; CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == f && (f = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", g = 1); f = b.document.createElement(f); f.setHtml("a" + c); c = f.getHtml().substr(1); c = c.replace(new RegExp("data-cke-" + CKEDITOR.rnd + "-", "ig"), ""); g && (c = c.replace(/^<pre>|<\/pre>$/gi, "")); c = c.replace(P, "$1$2"); c = z(c); c = y(c); f = !1 === a.fixForBody ? !1 :
                        d(a.enterMode, b.config.autoParagraph); c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, f); f && (g = c, !g.children.length && CKEDITOR.dtd[g.name][f] && (f = new CKEDITOR.htmlParser.element(f), g.add(f))); a.dataValue = c
                ...
                a.data.filter.applyTo(a.data.dataValue,
                    !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = g.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = y(c); c = G(c, b); a.data.dataValue = c }, null, null, 15)
        }; CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var f = this.editor, e, g, m, t; b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, g = b.filter, m = b.enterMode, t = b.protectedWhitespaces) : e = b; e || null === e || (e = f.editable().getName()); return f.fire("toHtml", {
                    dataValue: a, context: e, fixForBody: c, dontFilter: d,
                    filter: g || f.filter, enterMode: m || f.enterMode, protectedWhitespaces: t
                }).dataValue
        ...
        }; var H = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", I = CKEDITOR.dtd, K = "caption colgroup col thead tfoot tbody".split(" "), m = CKEDITOR.tools.extend({}, I.$blockLimit,
            I.$block), F = { elements: { input: h, textarea: h } }, M = { attributeNames: [[/^on/, "data-cke-pa-on"], [/^srcdoc/, "data-cke-pa-srcdoc"], [/^data-cke-expando$/, ""]], elements: { iframe: function (a) { if (a.attributes && a.attributes.src) { var b = a.attributes.src.toLowerCase().replace(/[^a-z]/gi, ""); if (0 === b.indexOf("javascript") || 0 === b.indexOf("data")) a.attributes["data-cke-pa-src"] = a.attributes.src, delete a.attributes.src } } } }, A = {
                elements: {
                    embed: function (a) {
                ...
                elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]], elements: {
                    ...
                    }, style: function (a) { var b = a.children[0]; b && b.value && (b.value = CKEDITOR.tools.trim(b.value)); a.attributes.type || (a.attributes.type = "text/css") }, title: function (a) { var b = a.children[0]; !b && l(a, b = new CKEDITOR.htmlParser.text); b.value = a.attributes["data-cke-title"] || "" }, input: k, textarea: k
            ...
            }); var r = /<(a|area|img|input|source)\b([^>]*)>/gi, E = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, D = /^(href|src|name)$/i, u = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, S = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, T = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, t = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, P = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, J = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
    ...
    (function () {
        function a(a) { return function (b) { return b.type == CKEDITOR.NODE_ELEMENT && ("string" == typeof a ? b.name == a : b.name in a) } } var d = function (a, b) { a = a[0]; b = b[0]; return a < b ? -1 : a > b ? 1 : 0 }, b = CKEDITOR.htmlParser.fragment.prototype; CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            }, filterChildren: b.filterChildren, writeHtml: function (a, b) { b && this.filter(b); var f = this.name, l = [], h = this.attributes, k, p; a.openTag(f, h); for (k in h) l.push([k, h[k]]); a.sortAttributes && l.sort(d); k = 0; for (p = l.length; k < p; k++)h = l[k], a.attribute(h[0], h[1]); a.openTagClose(f, this.isEmpty); this.writeChildrenHtml(a); this.isEmpty || a.closeTag(f) }, writeChildrenHtml: b.writeChildrenHtml, replaceWithChildren: function () {
    ...
    (function () {
        CKEDITOR.inline = function (a, d) {
            ...
            var a,
            d, b; for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), g = 0, f = c.count(); g < f; g++)a = c.getItem(g), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = { element: a, config: {} }, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
        }; CKEDITOR.domReady(function () { !CKEDITOR.disableAutoInline && CKEDITOR.inlineAll() })
    })(); CKEDITOR.replaceClass = "ckeditor";
    (function () {
        function a(a, g, f, l) {
            a = CKEDITOR.editor._getEditorElement(a); if (!a) return null; var h = new CKEDITOR.editor(g, a, l); l == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), h._.required = a.hasAttribute("required"), a.removeAttribute("required")); f && h.setData(f, null, !0); h.on("loaded", function () {
    ...
    (function () {
        ...
        function b(a) { var b = a.data.getTarget(); b.is("input") && (b = b.getAttribute("type"), "submit" != b && "reset" != b || a.data.preventDefault()) } function c(a) { return z(a) && w(a) } function g(a, b) { return function (c) { var d = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget; (d = d && d.nodeType == CKEDITOR.NODE_ELEMENT ? new CKEDITOR.dom.element(d) : null) && (b.equals(d) || b.contains(d)) || a.call(this, c) } } function f(a) {
            ...
            n, H, x, I, K; CKEDITOR.editable = CKEDITOR.tools.createClass({
                base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                    ...
                    fixInitialSelection: function () {
                        ...
                        if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"), f = 0, g; if (d) for (; g = d.getItem(f++);)if (!w(g)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), y(a.startContainer) && a.startContainer.appendBogus(); a.startContainer.mergeSiblings(); return e
                    }, setup: function () {
                        var a = this.editor; this.attachListener(a, "beforeGetData", function () {
                            var b =
                                this.getData(); this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(q, function (a, b) { return b })); a.setData(b, null, 1)
                                        ...
                                        !a.config.disableNativeSpellChecker); var h = a.config.contentsLangDirection; this.getDirection(1) != h && this.changeAttr("dir", h); var l = CKEDITOR.getCss(); if (l) { var h = g.getHead(), r = h.getCustomData("stylesheet"); r ? l != r.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? r.$.styleSheet.cssText = l : r.setText(l)) : (l = g.appendStyleText(l), l = new CKEDITOR.dom.element(l.ownerNode || l.owningElement), h.setCustomData("stylesheet", l), l.data("cke-temp", 1)) } h = g.getCustomData("stylesheet_ref") || 0; g.setCustomData("stylesheet_ref",
                                            h + 1); this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling); this.attachListener(this, "click", function (a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a"); b && 2 != a.$.button && b.isReadOnly() && a.preventDefault() }); var k = { 8: 1, 46: 1 }; this.attachListener(a, "key", function (b) {
                                                if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d; b = a.getSelection(); if (0 !== b.getRanges().length) {
                                                    if (c in k) {
                                                        var e, g = b.getRanges()[0], h = g.startPath(), r, l, B, c = 8 == c; CKEDITOR.env.ie &&
                                                            ...
                                                            var f =
                                                                b.block; if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                                                    if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var g = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (g && g.type == CKEDITOR.NODE_ELEMENT && g.is("hr")) { a.fire("saveSnapshot"); g.remove(); b = !0; break a } } d = d.startPath().block; if (!d || d && d.contains(f)) b = void 0; else {
                                                                        a.fire("saveSnapshot"); var h; (h = (c ? d : f).getBogus()) && h.remove(); h = a.getSelection(); g = h.createBookmarks(); (c ? f : d).moveChildren(c ?
                                                                            d : f, !1); b.lastElement.mergeSiblings(); e(f, d, !c); h.selectBookmarks(g); b = !0
                                                                    }
                                                                } else b = !1
        ...
        z = CKEDITOR.dom.walker.whitespaces(!0); w = CKEDITOR.dom.walker.bookmark(!1, !0); y = CKEDITOR.dom.walker.empty(); G = CKEDITOR.dom.walker.bogus(); q = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; n = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                var e, f, g, h, r = [], l = d.range.startContainer; e = d.range.startPath(); for (var l = D[l.getName()], k = 0, E = c.getChildren(), u = E.count(), p = -1, n = -1, S = 0, A = e.contains(D.$list); k <
                ...
                var e = [],
                f = b.getChildren(), g = f.count(), h, r = 0, l = D[c], k = !b.is(D.$inline) || b.is("br"); for (k && e.push(" "); r < g; r++)h = f.getItem(r), a(h) && !h.is(l) ? e = e.concat(d(h, c)) : e.push(h); k && e.push(" "); return e
            ...
            } function E(b, c) { function d(b, c) { if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is("br")) return b.remove(), 1 } var e = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset - 1); e && d(e, b[b.length - 1]); f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse()) } var D = CKEDITOR.dtd, u = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, p = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, n = CKEDITOR.tools.extend({}, D.$inline); delete n.br; return function (t, u, J, v) {
                var B = t.editor, C = !1; "unfiltered_html" == u && (u = "html", C = !0); if (!v.checkReadOnly()) {
                    var z = (new CKEDITOR.dom.elementPath(v.startContainer, v.root)).blockLimit || v.root; u = { type: u, dontFilter: C, editable: t, editor: B, range: v, blockLimit: z, mergeCandidates: [], zombies: [] }; var C = u.range, z = u.mergeCandidates, L = "html" === u.type, q, w, y, x, G, V; "text" == u.type &&
                        C.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (w = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", C.document), C.insertNode(w), C.setStartAfter(w)); y = new CKEDITOR.dom.elementPath(C.startContainer); u.endPath = x = new CKEDITOR.dom.elementPath(C.endContainer); if (!C.collapsed) { q = x.block || x.blockLimit; var aa = C.getCommonAncestor(); q && !q.equals(aa) && !q.contains(aa) && C.checkEndOfBlock() && u.zombies.push(q); C.deleteContents() } for (; (G = e(C)) && a(G) && G.isBlockBoundary() && y.contains(G);)C.moveToPosition(G,
                            CKEDITOR.POSITION_BEFORE_END); g(C, u.blockLimit, y, x); w && (C.setEndBefore(w), C.collapse(), w.remove()); w = C.startPath(); if (q = w.contains(f, !1, 1)) V = C.splitElement(q), u.inlineStylesRoot = q, u.inlineStylesPeak = w.lastElement; w = C.createBookmark(); L && (k(q), k(V)); (q = w.startNode.getPrevious(c)) && a(q) && f(q) && z.push(q); (q = w.startNode.getNext(c)) && a(q) && f(q) && z.push(q); for (q = w.startNode; (q = q.getParent()) && f(q);)z.push(q); C.moveToBookmark(w); B.enterMode === CKEDITOR.ENTER_DIV && "" === B.getData(!0) && ((B = t.getFirst()) && B.remove(),
                                v.setStartAt(t, CKEDITOR.POSITION_AFTER_START), v.collapse(!0)); if (t = J) {
                                    t = u.range; if ("text" == u.type && u.inlineStylesRoot) { v = u.inlineStylesPeak; B = v.getDocument().createText("{cke-peak}"); for (V = u.inlineStylesRoot.getParent(); !v.equals(V);)B = B.appendTo(v.clone()), v = v.getParent(); J = B.getOuterHtml().split("{cke-peak}").join(J) } v = u.blockLimit.getName(); if (/^\s+|\s+$/.test(J) && "span" in CKEDITOR.dtd[v]) { var H = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; J = H + J + H } J = u.editor.dataProcessor.toHtml(J,
                                        { context: null, fixForBody: !1, protectedWhitespaces: !!H, dontFilter: u.dontFilter, filter: u.editor.activeFilter, enterMode: u.editor.activeEnterMode }); v = t.document.createElement("body"); v.setHtml(J); H && (v.getFirst().remove(), v.getLast().remove()); if ((H = t.startPath().block) && (1 != H.getChildCount() || !H.getBogus())) a: {
                                            var Q; if (1 == v.getChildCount() && a(Q = v.getFirst()) && Q.is(p) && !Q.hasAttribute("contenteditable")) {
                                                H = Q.getElementsByTag("*"); t = 0; for (V = H.count(); t < V; t++)if (B = H.getItem(t), !B.is(n)) break a; Q.moveChildren(Q.getParent(1));
                                                Q.remove()
                                            }
                                        } u.dataWrapper = v; t = J
                                } if (t) {
                                    Q = u.range; t = Q.document; v = u.blockLimit; V = 0; var R, H = [], I, O; J = w = 0; var K, B = Q.startContainer; G = u.endPath.elements[0]; var Z, C = G.getPosition(B), z = !!G.getCommonAncestor(B) && C != CKEDITOR.POSITION_IDENTICAL && !(C & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED), B = b(u.dataWrapper, u); for (E(B, Q); V < B.length; V++) {
                                        C = B[V]; if (L = C.isLineBreak) L = Q, q = v, x = y = void 0, C.hasBlockSibling ? L = 1 : (y = L.startContainer.getAscendant(D.$block, 1)) && y.is({ div: 1, p: 1 }) ? (x = y.getPosition(q), x ==
                                            CKEDITOR.POSITION_IDENTICAL || x == CKEDITOR.POSITION_CONTAINS ? L = 0 : (q = L.splitElement(y), L.moveToPosition(q, CKEDITOR.POSITION_AFTER_START), L = 1)) : L = 0; if (L) J = 0 < V; else {
                                                L = Q.startPath(); !C.isBlock && l(u.editor, L.block, L.blockLimit) && (O = h(u.editor)) && (O = t.createElement(O), O.appendBogus(), Q.insertNode(O), CKEDITOR.env.needsBrFiller && (R = O.getBogus()) && R.remove(), Q.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END)); if ((L = Q.startPath().block) && !L.equals(I)) { if (R = L.getBogus()) R.remove(), H.push(L); I = L } C.firstNotAllowed &&
                                                ...
                                                C.lastNotAllowed && V < B.length - 1 && ((K = z ? G : K) && Q.setEndAt(K, CKEDITOR.POSITION_AFTER_START), w = 0); Q.collapse()
                                            }
                                    } 1 != B.length ? R = !1 : (R = B[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable")); R && (J = !0, L = B[0].node, Q.setStartAt(L, CKEDITOR.POSITION_BEFORE_START), Q.setEndAt(L, CKEDITOR.POSITION_AFTER_END)); u.dontMoveCaret = J; u.bogusNeededBlocks = H
                                } R = u.range; var Y; Z = u.bogusNeededBlocks; for (I = R.createBookmark(); O = u.zombies.pop();)O.getParent() && (K = R.clone(), K.moveToElementEditStart(O), K.removeEmptyBlocksAtEnd());
                    if (Z) for (; O = Z.pop();)CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(R.document.createText(" ")); for (; O = u.mergeCandidates.pop();)O.mergeSiblings(); CKEDITOR.env.webkit && R.startPath() && (O = R.startPath(), O.block ? O.block.$.normalize() : O.blockLimit && O.blockLimit.$.normalize()); R.moveToBookmark(I); if (!u.dontMoveCaret) {
                        for (O = e(R); O && a(O) && !O.is(D.$empty);) {
                            if (O.isBlockBoundary()) R.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END); else {
                                if (f(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) { Y = null; break } Y = R.clone();
            ...
            bogus: { exclude: function (a) { var b = a.range.getBoundaryNodes(), c = b.startNode, b = b.endNode; !b || !G(b) || c && c.equals(b) || a.range.setEndBefore(b) } }, tree: {
            ...
            function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) { a(d); a(e, 1); for (var f; f = e.getNext();)f.insertAfter(d), d = f; y(c) && c.remove() } function c(a, b) { var d = new CKEDITOR.dom.range(a); d.setStartAfter(b.startNode); d.setEndBefore(b.endNode); return d } return {
                list: {
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
            ...
            return c += d.join("\t")
        } function g(a) { var b = this.root.editor, d = b.getSelection(1); this.reset(); K = !0; d.root.once("selectionchange", function (a) { a.cancel() }, null, null, 0); d.selectRanges([a[0]]); d = this._.cache; d.ranges = new CKEDITOR.dom.rangeList(a); d.type = CKEDITOR.SELECTION_TEXT; d.selectedElement = a[0]._getTableElement(); d.selectedText = c(a); d.nativeSel = null; this.isFake = 1; this.rev = H++; b._.fakeSelection = this; K = !1; this.root.fire("selectionchange") } function f() {
        ...
        } function l() { F = !0; m || (h.call(this), m = CKEDITOR.tools.setTimeout(h, 200, this)) } function h() { m = null; F && (CKEDITOR.tools.setTimeout(f, 0, this), F = !1) } function k(a) { return M(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function p(a) {
        ...
        } function e(a) { z(a, !1); var b = a.getDocument().createText(x); a.setCustomData("cke-fillingChar", b); return b } function z(a, b) {
        ...
        } function w(a, b) { return b ? a.replace(I, function (a, b) { return b ? " " : "" }) : a.replace(x, "") } function y(a, b) {
        ...
        } function G(a) { var b = { 37: 1, 39: 1, 8: 1, 46: 1 }; return function (c) { var d = c.data.getKeystroke(); if (b[d]) { var e = a.getSelection().getRanges(), f = e[0]; 1 == e.length && f.collapsed && (d = f[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") && (a.getSelection().fake(d), c.data.preventDefault(), c.cancel()) } } } function q(a) {
        ...
        } var n = "function" != typeof window.getSelection, H = 1, x = CKEDITOR.tools.repeat("​", 7), I = new RegExp(x + "( )?", "g"), K, m, F, M = CKEDITOR.dom.walker.invisible(1), A = function () {
            function a(b) {
                return function (a) {
                    var c =
            ...
            function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                function a() { q = new CKEDITOR.dom.selection(c.getSelection()); q.lock() } function b() { h.removeListener("mouseup", b); m.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection, c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == g.$ && c.select() } function d(a) {
                    var b,
                    c; b = (b = this.document.getActive()) ? "input" === b.getName() || "textarea" === b.getName() : !1; b || (b = this.getSelection(1), (c = e(b)) && !c.equals(k) && (b.selectElement(c), a.data.preventDefault()))
                } function e(a) { a = a.getRanges()[0]; return a ? (a = a.startContainer.getAscendant(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null : null } var g = c.document, h = CKEDITOR.document, k = c.editable(), r = g.getBody(), m = g.getDocumentElement(), p = k.isInline(),
                    E, q; CKEDITOR.env.gecko && k.attachListener(k, "focus", function (a) { a.removeListener(); 0 !== E && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == k.$ && (a = c.createRange(), a.moveToElementEditStart(k), a.select()) }, null, null, -2); k.attachListener(k, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                        if (E && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                            E = c._.previousActive && c._.previousActive.equals(g.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != k.$.scrollTop;
                            CKEDITOR.env.webkit && E && a && (k.$.scrollTop = c._.previousScrollTop)
                        } c.unlockSelection(E); E = 0
                    }, null, null, -1); k.attachListener(k, "mousedown", function () { E = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || p) n ? k.attachListener(k, "beforedeactivate", a, null, null, -1) : k.attachListener(c, "selectionCheck", a, null, null, -1), k.attachListener(k, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function () { var a = q && (q.isFake || 2 > q.getRanges().length); CKEDITOR.env.gecko && !p && a || (c.lockSelection(q), E = 1) }, null, null, -1),
                        k.attachListener(k, "mousedown", function () { E = 0 }); if (CKEDITOR.env.ie && !p) {
                            var w; k.attachListener(k, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (w = c.window.getScrollPosition())) }); k.attachListener(k, "mouseup", function (a) { 2 == a.data.$.button && w && (c.document.$.documentElement.scrollLeft = w.x, c.document.$.documentElement.scrollTop = w.y); w = null }); if ("BackCompat" != g.$.compatMode) {
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var y, x;
                                    m.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (y) { var c = r.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } y.setEndPoint(0 > x.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); y.select() } } function c() { m.removeListener("mousemove", b); h.removeListener("mouseup", c); m.removeListener("mouseup", c); y.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < m.$.clientHeight && a.$.x < m.$.clientWidth) {
                                            y = r.$.createTextRange(); try { y.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } x =
                                                y.duplicate(); m.on("mousemove", b); h.on("mouseup", c); m.on("mouseup", c)
                                        }
                                    })
                        ...
                        } k.attachListener(k, "selectionchange", f, c); k.attachListener(k, "keyup", l, c); k.attachListener(k, "touchstart", l, c); k.attachListener(k, "touchend", l, c); CKEDITOR.env.ie && k.attachListener(k, "keydown", d, c); k.attachListener(k, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                            c.forceNextSelectionCheck();
                            c.selectionChange(1)
                        }); if (p && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var A; k.attachListener(k, "mousedown", function () { A = 1 }); k.attachListener(g.getDocumentElement(), "mouseup", function () { A && l.call(c); A = 0 }) } else k.attachListener(CKEDITOR.env.ie ? k : g.getDocumentElement(), "mouseup", l, c); CKEDITOR.env.webkit && k.attachListener(g, "keydown", function (a) { switch (a.data.getKey()) { case 13: case 33: case 34: case 35: case 36: case 37: case 39: case 8: case 45: case 46: k.hasFocus && z(k) } }, null, null, -1); k.attachListener(k,
        ...
        }); CKEDITOR.editor.prototype.selectionChange = function (a) { (a ? f : l).call(this) }; CKEDITOR.editor.prototype.getSelection = function (a) {
            ...
            function (a) {
            ...
            }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: w, _createFillingCharSequenceNode: e, FILLING_CHAR_SEQUENCE: x }); CKEDITOR.dom.selection.prototype = {
                getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: n ? function () {
                    ...
                    }; return function (b) { var c = this._.cache, d = c.ranges; d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? q(new CKEDITOR.dom.rangeList(d.slice())) : d }
                    ...
                    var b = this.root.editor, c = b && b._.hiddenSelectionContainer; this.reset(); if (c) for (var c = this.root, f, h = 0; h < a.length; ++h)f =
                        a[h], f.endContainer.equals(c) && (f.endOffset = Math.min(f.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var l = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); l && !l.equals(this.root) && l.focus() } else {
                            var k; a: {
                                ...
                                if (n) {
                                    m = CKEDITOR.dom.walker.whitespaces(!0); k = /\ufeff|\u00a0/; J = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var v, B, C; if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in N && (!c.is("a") ||
                                    ...
                                    l = this.getNative(); if (!l) return; this.removeAllRanges(); for (C = 0; C < a.length; C++) {
                                        if (C < a.length - 1 && (v = a[C], B = a[C + 1], k = v.clone(), k.setStart(v.endContainer, v.endOffset), k.setEnd(B.startContainer, B.startOffset), !k.collapsed && (k.shrink(CKEDITOR.NODE_ELEMENT, !0), b = k.getCommonAncestor(), k = k.getEnclosedNode(), b.isReadOnly() || k && k.isReadOnly()))) { B.setStart(v.startContainer, v.startOffset); a.splice(C--, 1); continue } b = a[C]; B = this.document.$.createRange(); b.collapsed &&
                                            CKEDITOR.env.webkit && p(b) && (k = e(this.root), b.insertNode(k), (v = k.getNext()) && !k.getPrevious() && v.type == CKEDITOR.NODE_ELEMENT && "br" == v.getName() ? (z(this.root), b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(k, CKEDITOR.POSITION_AFTER_END)); B.setStart(b.startContainer.$, b.startOffset); try { B.setEnd(b.endContainer.$, b.endOffset) } catch (w) { if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), B.setEnd(b.endContainer.$, b.endOffset); else throw w; } l.addRange(B)
                                    }
                                } this.reset();
                                this.root.fire("selectionchange")
                            }
                        }
                }, fake: function (a, b) { var c = this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); y(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = H++; c._.fakeSelection = this; this.root.fire("selectionchange") }, isHidden: function () {
                    var a =
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
                        ...
                        k = !1; if (w.equals(r)) w = null, k = !0; else {
                            ...
                            for (var k = H(this, e), y = k.hasAttributes(), x = z.getCommonAncestor(),
                                u = {}, E = {}, F = {}, I = {}, X, W, Y; k && x;) { if (x.getName() == f) { for (X in h.attributes) !I[X] && (Y = x.getAttribute(W)) && (k.getAttribute(X) == Y ? E[X] = 1 : I[X] = 1); for (W in h.styles) !F[W] && (Y = x.getStyle(W)) && (k.getStyle(W) == Y ? u[W] = 1 : F[W] = 1) } x = x.getParent() } for (X in E) k.removeAttribute(X); for (W in u) k.removeStyle(W); y && !k.hasAttributes() && (k = null); k ? (z.extractContents().appendTo(k), z.insertNode(k), G.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), z.extractContents().appendTo(k),
                                    z.insertNode(k), G.call(this, k), k.remove(!0)); z = null
                        }
            ...
            function b() {
                ...
                var m = c.endNode, p = this; b(); for (f = d; !f.equals(m);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? y.call(this, f) : q(f, K(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) &&
                    (b(), g = d.getNext())), f = g
            } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function g(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function f(a) { var b = a.getEnclosedNode() || a.getCommonAncestor(!1, !0); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && x(a, this) } function l(a) {
            ...
            c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), p(d, e)) : y.call(this, d)); a.moveToBookmark(b)
        } function p(a, b) {
            ...
            q(a, e, A[a.getName()]); f && (this._.definition.alwaysRemoveElement ? n(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? n(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        } function G(a) { for (var b = K(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || y.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || q(d, b[f]) } function q(a,
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], f; if (f = a.getAttribute(e)) { var g = b[d][1]; (null === g || g.test && g.test(f) || "string" == typeof g && f == g) && a.removeAttribute(e) } } c || n(a) } function n(a, b) {
            ...
            } function H(a, b, c) { var d; d = a.element; "*" == d && (d = "span"); d = new CKEDITOR.dom.element(d, b); c && c.copyAttributes(d); d = x(d, a); b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") : b.setCustomData("doc_processing_style", 1); return d } function x(a, b) {
            ...
            } function I(a, b) { for (var c in a) a[c] = a[c].replace(E, function (a, c) { return b[c] }) } function K(a) {
            ...
            } function m(a, b, c) { var d = new CKEDITOR.dom.element("span"); d[c ? "setStyle" : "setAttribute"](a, b); return d[c ? "getStyle" : "getAttribute"](a) } function F(a, b) {
                ...
                return !0
            } function M(a, b, c) { var d = a.getRanges(); b = b ? this.removeFromRange : this.applyToRange; for (var e, f = d.createIterator(); e = f.getNextRange();)b.call(this, e, c); a.selectRanges(d) } var A = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, N = {
                a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1,
                dt: 1, dd: 1, form: 1, audio: 1, video: 1
            }, r = /\s*(?:;\s*|$)/, E = /#\((.+?)\)/g, D = CKEDITOR.dom.walker.bookmark(0, 1), u = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                if ("string" == typeof a.type) return new CKEDITOR.style.customHandlers[a.type](a); var c = a.attributes; c && c.style && (a.styles = CKEDITOR.tools.extend({}, a.styles, CKEDITOR.tools.parseCssText(c.style)), delete c.style); b && (a = CKEDITOR.tools.clone(a), I(a.attributes, b), I(a.styles, b)); c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                    a.element : "*"; this.type = a.type || (A[c] ? CKEDITOR.STYLE_BLOCK : N[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE); "object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT); this._ = { definition: a }
            }; CKEDITOR.style.prototype = {
                apply: function (a) { if (a instanceof CKEDITOR.dom.document) return M.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); M.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                    if (a instanceof
                        CKEDITOR.dom.document) return M.call(this, a.getSelection(), 1); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); M.call(this, a.getSelection(), 1, a); this._.enterMode = b }
                }, applyToRange: function (a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? f : null; return this.applyToRange(a) }, removeFromRange: function (a) {
        ...
        }; var S = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, T = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    ...
    (function () {
        function a(a, g, f) { a.once("selectionCheck", function (a) { if (!d) { var c = a.data.getRanges()[0]; f.equals(c) ? a.cancel() : g.equals(c) && (b = !0) } }, null, null, -1) } var d = !0, b = !1; CKEDITOR.dom.selection.setupEditorOptimization = function (a) {
            ...
            $: function (a, b) {
                ...
                initialColorCode: "", isValidColor: !0, red: 0, green: 0, blue: 0, alpha: 1, blendAlphaColor: function (a, b, c, d) {
                    ...
                    var c = this._.extractColorChannelsByPattern(b, CKEDITOR.tools.color.rgbRegExp); if (!c || (b = 0 === b.indexOf("rgba")) && 4 !== c.length || !b && 3 !== c.length) return null; var g = a(c[0], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE), k = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE), p = a(c[2], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
                        e = 1; b && (e = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE)); return this._.areColorChannelsValid(g, k, p, e) ? [g, k, p, e] : null
                    ...
                    var c = this._.extractColorChannelsByPattern(b, CKEDITOR.tools.color.hslRegExp); if (!c || (b = 0 === b.indexOf("hsla")) && 4 !== c.length || !b && 3 !== c.length) return null; var g = a(c[0], CKEDITOR.tools.color.MAX_HUE_CHANNEL_VALUE), k = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE), p = d(c[2], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
                        e = 1, g = this._.hslToRgb(g, k, p); b && (e = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE)); g.push(e); return this._.areColorChannelsValid(g[0], g[1], g[2], g[3]) ? g : null
                ...
                }, hslToRgb: function (a, b, c) { var d = function (d) { var e = (d + a / 30) % 12; d = b * Math.min(c, 1 - c); e = Math.min(e - 3, 9 - e, 1); e = Math.max(-1, e); return Math.round((c - d * e) * CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) }; return [d(0), d(8), d(4)] }, rgbToHsl: function (a, b, c) {
                    a /= CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE; b /= CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE; var d = c / CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE,
                        g = Math.max(a, b, d), e = Math.min(a, b, d); c = g - e; var z = 0; switch (g) { case a: z = (b - d) / c % 6; break; case b: z = (d - a) / c + 2; break; case d: z = (a - b) / c + 4 }a = 0 === c ? 0 : 60 * z; b = (g + e) / 2; g = 0; 1 !== b && 0 !== b && (g = c / (1 - Math.abs(2 * b - 1))); a = Math.round(a); g = 100 * Math.round(g); return [a, g, 100 * b]
                }
            }, statics: {
    ...
    (function () {
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, g) {
            var f = null, l = null, h = [], k = b, p; g = g || b.getDocument().getBody(); k || (k = g); do if (k.type == CKEDITOR.NODE_ELEMENT) {
                h.push(k); if (!this.lastElement && (this.lastElement = k, k.is(CKEDITOR.dtd.$object) || "false" == k.getAttribute("contenteditable"))) continue; if (k.equals(g)) break; if (!l && (p = k.getName(),
                    "true" == k.getAttribute("contenteditable") ? l = k : !f && d[p] && (f = k), a[p])) { if (p = !f && "div" == p) { a: { p = k.getChildren(); for (var e = 0, z = p.count(); e < z; e++) { var w = p.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { p = !0; break a } } p = !1 } p = !p } p ? f = k : l = k }
            } while (k = k.getParent()); l || (l = g); this.block = f; this.blockLimit = l; this.root = g; this.elements = h
        }
    })();
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) { var d = this.elements; a = a && a.elements; if (!a || d.length != a.length) return !1; for (var b = 0; b < d.length; b++)if (!d[b].equals(a[b])) return !1; return !0 }, contains: function (a, d, b) {
            var c = 0, g; "string" == typeof a && (g = function (b) { return b.getName() == a }); a instanceof CKEDITOR.dom.element ? g = function (b) { return b.equals(a) } : CKEDITOR.tools.isArray(a) ? g = function (b) { return -1 < CKEDITOR.tools.indexOf(a, b.getName()) } : "function" == typeof a ? g = a : "object" == typeof a && (g = function (b) {
                return b.getName() in
                    a
            }); var f = this.elements, l = f.length; d && (b ? c += 1 : --l); b && (f = Array.prototype.slice.call(f, 0), f.reverse()); for (; c < l; c++)if (g(f[c])) return f[c]; return null
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () { return this.$.nodeValue.length }, getText: function () { return this.$.nodeValue }, setText: function (a) { this.$.nodeValue = a }, isEmpty: function (a) { var d = this.getText(); a && (d = CKEDITOR.tools.trim(d)); return !d || d === CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE }, split: function (a) {
            var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(), g = this.getDocument(), f = new CKEDITOR.dom.text(this.$.splitText(a), g); d.childNodes.length ==
                b && (a >= c ? (f = g.createText(""), f.insertAfter(this)) : (a = g.createText(""), a.insertAfter(f), a.remove())); return f
            ...
            createIterator: function () {
                var a = this, c = CKEDITOR.dom.walker.bookmark(), d = [], f; return {
                    getNextRange: function (l) {
                        f = void 0 === f ? 0 : f + 1; var h = a[f]; if (h && 1 < a.length) {
                            if (!f) for (var k = a.length - 1; 0 <= k; k--)d.unshift(a[k].createBookmark(!0)); if (l) for (var p = 0; a[f + p + 1];) {
                                var e = h.document; l = 0; k = e.getById(d[p].endNode); for (e = e.getById(d[p + 1].startNode); ;) {
                                    k =
                                    k.getNextSourceNode(!1); if (e.equals(k)) l = 1; else if (c(k) || k.type == CKEDITOR.NODE_ELEMENT && k.isBlockBoundary()) continue; break
                                } if (!l) break; p++
                            } for (h.moveToBookmark(d.shift()); p--;)k = a[++f], k.moveToBookmark(d.shift()), h.setEnd(k.endContainer, k.endOffset)
                        } return h
                    }
                }
            }, createBookmarks: function (b) { for (var c = [], d, f = 0; f < this.length; f++) { c.push(d = this[f].createBookmark(b, !0)); for (var l = f + 1; l < this.length; l++)this[l] = a(d, this[l]), this[l] = a(d, this[l], !0) } return c }, createBookmarks2: function (a) {
                for (var c = [], d = 0; d <
    ...
    (function () {
        function a() { return CKEDITOR.getUrl(CKEDITOR.skinName.split(",")[1] || "skins/" + CKEDITOR.skinName.split(",")[0] + "/") } function d(b) { var c = CKEDITOR.skin["ua_" + b], d = CKEDITOR.env; if (c) for (var c = c.split(",").sort(function (a, b) { return a > b ? -1 : 1 }), f = 0, g; f < c.length; f++)if (g = c[f], d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"), d[g]) { b += "_" + c[f]; break } return CKEDITOR.getUrl(a() + b + ".css") } function b(a, b) { f[a] || (CKEDITOR.document.appendStyleSheet(d(a)), f[a] = 1); b && b() } function c(a) {
            var b =
            ...
            getUiColor: function () { return this.uiColor }, setUiColor: function (a) {
                var b = c(CKEDITOR.document); return (this.setUiColor = function (a) {
                    this.uiColor = a; var c = CKEDITOR.skin.chameleon, d = "", f = ""; "function" == typeof c && (d = c(this, "editor"), f =
                        c(this, "panel")); a = [[k, a]]; g([b], d, a); g(h, f, a)
                }).call(this, a)
            }
...
*/
    ...
    CKEDITOR.skin.chameleon = function () {
        var b = function () { return function (b, e) { for (var a = b.match(/[^#]./g), c = 0; 3 > c; c++) { var f = a, h = c, d; d = parseInt(a[c], 16); d = ("0" + (0 > e ? 0 | d * (1 + e) : 0 | d + (255 - d) * e).toString(16)).slice(-2); f[h] = d } return "#" + a.join("") } }(), c = function () {
            var b = new CKEDITOR.template("background:#{to};background-image:linear-gradient(to bottom,{from},{to});filter:progid:DXImageTransform.Microsoft.gradient(gradientType=0,startColorstr='{from}',endColorstr='{to}');"); return function (c, a) {
                return b.output({
                    from: c,
                    to: a
                })
    ...
    (function () {
        ...
        var q, k, l; CKEDITOR.plugins.add("colorbutton", {
            requires: "panelbutton,floatpanel", init: function (a) {
                function b(d) {
                    function b() { var d = a.config["colorButton_" + h + "Style"]; d.childRule = "back" == h ? function (a) { return f(a) } : function (a) { return !(a.is("a") || a.getElementsByTag("a").count()) || f(a) }; return d } function A(d, x, e) {
                        var c = {}; d && (c.color = d); x && (c.colorName = x); x = !CKEDITOR.tools.isEmpty(c) && new CKEDITOR.style(b(), c); a.execCommand(m, { newStyle: x }); if (d && e) for (e.addColor(d.substr(1).toUpperCase()),
                            d = t.element.find("[role\x3doption]").toArray(), e = 0; e < d.length; e++)d[e].setAttributes({ "aria-posinset": e + 1, "aria-setsize": d.length })
                    } var g = d.name, h = d.type, k = d.title, C = d.order, m = d.commandName; d = d.contentTransformations || {}; var B = new CKEDITOR.style(r["colorButton_" + h + "Style"]), q = CKEDITOR.tools.getNextId() + "_colorBox", y = { type: h }, z = new CKEDITOR.style(r["colorButton_" + h + "Style"], { color: "inherit" }), w = function () {
                        return CKEDITOR.tools.addFunction(function (d, b, e) {
                            a.focus(); a.fire("saveSnapshot"); "?" == d ? a.getColorFromDialog(function (a) {
                                a &&
                                A(a, b, u)
                            }, null, y) : A(d && "#" + d, b, u); e && (e.setAttribute("cke_colorlast", !0), a.once("selectionChange", function () { e.removeAttribute("cke_colorlast") }))
                        })
                    }(), u = l.getRowLimit(a) ? new l(a, "back" == h ? "background-color" : "color", w) : void 0, t; a.addCommand(m, {
                        contextSensitive: !0, exec: function (a, d) { if (!a.readOnly) { var b = d.newStyle; a.removeStyle(z); a.focus(); b && a.applyStyle(b); a.fire("saveSnapshot") } }, refresh: function (a, d) {
                            z.checkApplicable(d, a, a.activeFilter) ? z.checkActive(d, a) ? this.setState(CKEDITOR.TRISTATE_ON) :
                                this.setState(CKEDITOR.TRISTATE_OFF) : this.setState(CKEDITOR.TRISTATE_DISABLED)
                        }
                    }); a.ui.add(g, CKEDITOR.UI_PANELBUTTON, {
                        label: k, title: k, command: m, editorFocus: 0, toolbar: "colors," + C, allowedContent: B, requiredContent: B, contentTransformations: d, panel: { css: CKEDITOR.skin.getPath("editor"), attributes: { role: "listbox", "aria-label": n.panelTitle } }, select: function (a) { var d = r.colorButton_colors.split(","); a = CKEDITOR.tools.array.find(d, a); a = p(a); v(t, a); t._.markFirstDisplayed() }, onBlock: function (d, b) {
                            t = b; b.autoSize =
                                ...
                                "color"; if (e) {
                                    b = e.block || e.blockLimit || a.document.getBody(); do e = b && b.getComputedStyle(c) || "transparent"; while ("back" == h && "transparent" == e && b && (b = b.getParent())); e && "transparent" != e || (e = "#ffffff"); r.colorButton_enableAutomatic && t.element.findOne("#" + q).setStyle("background-color", e); if (b = d && d.getRanges()[0]) {
                                        for (var d = new CKEDITOR.dom.walker(b), g = b.collapsed ? b.startContainer : d.next(), b = ""; g;) {
                                            g.type !== CKEDITOR.NODE_ELEMENT && (g = g.getParent()); g = p(g.getComputedStyle(c)); b = b || g; if (b !== g) { b = ""; break } g =
                                                d.next()
                                        } "transparent" == b && (b = ""); "fore" == h && (y.automaticTextColor = "#" + p(e)); y.selectionColor = b ? "#" + b : ""; v(t, b)
                                    } return e
                                }
                        }
                    })
                    ...
                    for (b = 0; b < h.length; b++) { 0 === b % a.config.colorButton_colorsPerRow && g.push("\x3c/tr\x3e\x3ctr\x3e"); var m = h[b].split("/"), v = m[0], m = new q(a, { color: m[1] || v, label: m[1] ? v : void 0 }, c); m.setPositionIndex(p + b, f); g.push(m.getHtml()) } l.getRowLimit(a) && l.renderContainer(g, a); k && g.push("\x3c/tr\x3e", "\x3ctr\x3e", '\x3ctd colspan\x3d"', a.config.colorButton_colorsPerRow, '" align\x3d"center"\x3e', '\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', n.more, '"', ' draggable\x3d"false"', ' ondragstart\x3d"return false;"',
                        ' onclick\x3d"CKEDITOR.tools.callFunction(', c, ",'?');return false;\"", " href\x3d\"javascript:void('", n.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', f, '" aria-setsize\x3d"', f, '"\x3e', n.more, "\x3c/a\x3e", "\x3c/td\x3e"); g.push("\x3c/tr\x3e\x3c/tbody\x3e\x3c/table\x3e"); return g.join("")
                    ...
                    g && g.removeAttribute("aria-selected"); if (f) f.setAttribute("aria-selected", !0); else for (g = 0; g < c.count(); g++)if (f = c.getItem(g), b && b == p(f.getAttribute("data-value"))) { f.setAttribute("aria-selected", !0); break }
                } function p(a) { return CKEDITOR.tools.normalizeHex("#" + CKEDITOR.tools.convertRgbToHex(a || "")).replace(/#/g, "") } var r = a.config, n = a.lang.colorbutton; if (!CKEDITOR.env.hc) {
                    b({
                        name: "TextColor", type: "fore", commandName: "textColor", title: n.textColorTitle, order: 10, contentTransformations: [[{
                            element: "font",
                            check: "span{color}", left: function (a) { return !!a.attributes.color }, right: function (a) { a.name = "span"; a.attributes.color && (a.styles.color = a.attributes.color); delete a.attributes.color }
                        }]]
                    }); var k, w = a.config.colorButton_normalizeBackground; if (void 0 === w || w) k = [[{
                        element: "span", left: function (a) { var b = CKEDITOR.tools; if ("span" != a.name || !a.styles || !a.styles.background) return !1; a = b.style.parse.background(a.styles.background); return a.color && 1 === b.object.keys(a).length }, right: function (b) {
                            var c = (new CKEDITOR.style(a.config.colorButton_backStyle,
                                { color: b.styles.background })).getDefinition(); b.name = c.element; b.styles = c.styles; b.attributes = c.attributes || {}; return b
                        }
                    }]]; b({ name: "BGColor", type: "back", commandName: "bgColor", title: n.bgColorTitle, order: 20, contentTransformations: k })
                }
            }
        }); q = CKEDITOR.tools.createClass({
            $: function (a, b, c) { this.$ = new CKEDITOR.dom.element("td"); this.color = CKEDITOR.tools._isValidColorFormat(b.color) ? b.color : ""; this.clickFn = c; this.label = b.label || q.colorNames(a)[this.color] || this.color; this.setHtml() }, statics: { colorNames: function (a) { return a.lang.colorbutton.colors } },
            proto: {
            ...
            $: function () { this.$ = new CKEDITOR.dom.element("tr"); this.$.addClass("cke_colorhistory_row"); this.boxes = [] }, proto: {
                getElement: function () { return this.$ }, removeLastColor: function () { this.getElement().getLast().remove(); return this.boxes.pop() }, addNewColor: function (a) {
                    this.boxes.unshift(a); this.getElement().append(a.getElement(),
                        !0)
                }, extractColorBox: function (a) { var b = CKEDITOR.tools.getIndex(this.boxes, function (b) { return b.color === a }); if (0 > b) return null; this.boxes[b].getElement().remove(); return this.boxes.splice(b, 1)[0] }
            }
            ...
            $: function (a, b, c) { this.editor = a; this.cssProperty = b; this.clickFn = c; this.rows = []; this._.addNewRow(); if (this.editor.config.colorButton_renderContentColors) this.editor.once("instanceReady", function () { this.renderContentColors() }, this) }, statics: {
                renderContainer: function (a, b) {
                    a.push('\x3c/tbody\x3e\x3ctbody class\x3d"cke_colorhistory" style\x3d"display:none;"\x3e',
                        "\x3ctr\x3e", '\x3ctd colspan\x3d"', b.config.colorButton_colorsPerRow, '" align\x3d"center"\x3e', "\x3cspan\x3e\x3chr\x3e\x3c/span\x3e", "\x3c/td\x3e", "\x3c/tr\x3e", "\x3c/tbody\x3e\x3ctbody\x3e")
                ...
                countColors: function () {
                    var a = CKEDITOR.tools.getStyledSpans(this.cssProperty, this.editor.editable()); return CKEDITOR.tools.array.reduce(a,
                        function (a, c) { var f = this._.getHexCode(c, this.cssProperty, l.colorList); a[f] = a[f] || 0; a[f] += 1; return a }, {}, this)
                }, getHexCode: function (a, b, c) { var f = a.getStyle(b); return f in c ? c[f].substr(1) : this._.normalizeColor(a.getComputedStyle(b)).toUpperCase() }, sortByOccurrencesAscending: function (a, b) { var c = [], f; for (f in a) { var k = {}; k[b] = f; k.frequency = a[f]; c.push(k) } c.sort(function (a, b) { return b.frequency - a.frequency }); this._.trimToCapacity(c); return c.reverse() }, trimToCapacity: function (a) { a.splice(l.getCapacity(this.editor)) },
                ...
                alignRows: function () { for (var a = 0; a < l.getRowLimit(this.editor) && !(this.rows[a].boxes.length <= this.editor.config.colorButton_colorsPerRow); a++)this.rows[a + 1] ? this._.moveLastBoxToNextRow(a) : a < l.getRowLimit(this.editor) - 1 ? (this._.addNewRow(), this._.moveLastBoxToNextRow(a)) : this.rows[a].removeLastColor() }, moveLastBoxToNextRow: function (a) { this.rows[a + 1].addNewColor(this.rows[a].removeLastColor()) }, refreshPositions: function () {
                    var a = this._.countPanelElements(), b = this._.calculateFirstPosition(a); CKEDITOR.tools.array.forEach(this.rows,
                        function (c) { CKEDITOR.tools.array.forEach(c.boxes, function (c) { c.setPositionIndex(b, a); b += 1 }) })
                }, countPanelElements: function () { var a = this.editor.config.colorButton_colors.split(",").length + this.getLength(); this.editor.plugins.colordialog && this.editor.config.colorButton_enableMore && (a += 1); this.editor.config.colorButton_enableAutomatic && (a += 1); return a }, calculateFirstPosition: function (a) {
                    return this.editor.plugins.colordialog && this.editor.config.colorButton_enableMore ? a - this.getLength() : a - this.getLength() +
                        1
                }, attachRows: function () { CKEDITOR.tools.array.forEach(this.rows, function (a) { this.container.append(a.getElement()) }, this) }, normalizeColor: function (a) { return CKEDITOR.tools.normalizeHex("#" + CKEDITOR.tools.convertRgbToHex(a || "")).replace(/#/g, "") }
            }, proto: {
                setContainer: function (a) { this.container = a; this._.attachRows(); this.getLength() && this.show() }, show: function () { this.container && this.container.show() }, renderContentColors: function () {
                    var a = this._.countColors(); CKEDITOR.tools.isEmpty(a) || (a = this._.sortByOccurrencesAscending(a,
                        "colorCode"), this._.addColors(a), this._.refreshPositions())
    ...
    (function () {
        ...
        function k(a, b, e, d) { var c = new CKEDITOR.dom.walker(a); if (a = a.startContainer.getAscendant(b, !0) || a.endContainer.getAscendant(b, !0)) if (e(a), d) return; for (; a = c.next();)if (a = a.getAscendant(b, !0)) if (e(a), d) break } function u(a, b) { var e = { ul: "ol", ol: "ul" }; return -1 !== l(b, function (b) { return b.element === a || b.element === e[a] }) } function q(a) {
            ...
            lang: "ar,az,bg,cs,da,de,el,en,en-au,eo,es-mx,et,eu,fa,fr,gl,hr,hu,it,ja,ko,ku,lv,nb,nl,oc,pl,pt,pt-br,ro,ru,sk,sq,sr,sr-latn,sv,tr,uk,vi,zh,zh-cn", icons: "copyformatting", hidpi: !0, init: function (a) {
    ...
    (function (d) {
        ...
        c.t = function (a, b) { b & 1 && (a = c(a)); if (b & 8 || b & 4 && typeof a === a0_0x998a("0x31") && a && a[a0_0x998a("0x9")]) return a; var g = Object.create(null); c.r(g); Object[a0_0x998a("0x13")](g, "default", { enumerable: !0, value: a }); if (b & 2 && typeof a != a0_0x998a("0x3a")) for (var d in a) c.d(g, d, function (b) { return a[b] }[a0_0x998a("0x4b")](null, d)); return g }; c.n = function (a) { var b = a && a[a0_0x998a("0x9")] ? function () { return a[a0_0x998a("0x3c")] } : function () { return a }; c.d(b, "a", b); return b }; c.o = function (a, b) {
            return Object[a0_0x998a("0x53")][a0_0x998a("0x42")].call(a,
                b)
        }; c.p = ""; return c(c.s = 0)
    })([function (d, c, a) { d[a0_0x998a("0x6")] = a(1) }, function (d, c) {
        (function () {
            CKEDITOR[a0_0x998a("0x27")].add(a0_0x998a("0x2f"), {
                lang: "en", icons: a0_0x998a("0x2f"), hidpi: !0, isSupportedEnvironment: function () { return !CKEDITOR.env.ie || 10 < CKEDITOR[a0_0x998a("0x18")][a0_0x998a("0x1")] }, beforeInit: function (a) {
                    var c = a[a0_0x998a("0x2d")][a0_0x998a("0x1d")], b = this.createTokenFetcher(a, c); b[a0_0x998a("0x2e")](); a.on(a0_0x998a("0x7"), function (a) { a.data[a0_0x998a("0x33")] = b.token }, null, null,
                        16)
                }, init: function (a) {
                    function c() { return a.plugins.notification ? a[a0_0x998a("0x2")].apply(a, arguments) : { update: function () { }, hide: function () { } } } function b(f) {
                        if (!a[a0_0x998a("0x2d")][a0_0x998a("0x36")][a0_0x998a("0x5")] && !a.editable()[a0_0x998a("0x56")]()) {
                            var b = []; f = f.$[a0_0x998a("0x3e")]; try { CKEDITOR.tools[a0_0x998a("0x1c")].forEach(f, function (a) { CKEDITOR.tools[a0_0x998a("0x1c")].forEach(a[a0_0x998a("0x15")], function (a) { b[a0_0x998a("0x30")](a[a0_0x998a("0x38")]) }) }) } catch (c) {
                                CKEDITOR[a0_0x998a("0x2a")](a0_0x998a("0x14"),
                                    { error: c[a0_0x998a("0x4d")] })
                            } return b[a0_0x998a("0xf")]("")
                        }
                    } function g(a) { var b = new (CKEDITOR[a0_0x998a("0x11")][a0_0x998a("0x66")]); a = CKEDITOR[a0_0x998a("0x11")].fragment.fromHtml(a); a[a0_0x998a("0x23")](function (a) { a[a0_0x998a("0x16")] === a0_0x998a("0x69") && (a[a0_0x998a("0x64")].src = l(a[a0_0x998a("0x64")][a0_0x998a("0x4")])) }, CKEDITOR[a0_0x998a("0x55")], !1); a[a0_0x998a("0x3")](b); return b[a0_0x998a("0x62")]() } function d(b, c) {
                        b.addEventListener("progress", function () { c.update({ progress: .8 }) }); b.addEventListener("loadend",
                        ...
                        var b = a[a0_0x998a("0x2d")][a0_0x998a("0x25")]; return "function" ===
                            typeof b ? b() : b
                    } function m(a) { if (a) { var b = new FileReader; b.addEventListener("loadend", function (a) { a = JSON[a0_0x998a("0x46")](a.srcElement[a0_0x998a("0x57")]); console[a0_0x998a("0xb")](a) }); b[a0_0x998a("0x51")](a) } } function l(b) { var c = a.document.createElement("a"); c.$[a0_0x998a("0x67")] = b; return c.$.href } if (this[a0_0x998a("0x4e")]() && (a[a0_0x998a("0x24")]("exportPdf", {
                        exec: function (f) {
                            var k = c(f[a0_0x998a("0x3f")][a0_0x998a("0x2f")][a0_0x998a("0x2b")], "progress", 0), h = {
                                html: f.getData(), css: b(f[a0_0x998a("0x4a")]),
                                options: f[a0_0x998a("0x2d")].exportPdf_options
                            }; this.disable(); f.once(a0_0x998a("0x7"), function (b) {
                                k[a0_0x998a("0x20")]({ progress: .2 }); b[a0_0x998a("0x35")].html = g(b.data[a0_0x998a("0x63")]); var c = b.data; b = b[a0_0x998a("0x35")][a0_0x998a("0x63")]; var d = f[a0_0x998a("0x1b")]().getDirection(!0); b = (a[a0_0x998a("0x2d")][a0_0x998a("0x36")][a0_0x998a("0x5")] ? CKEDITOR[a0_0x998a("0x3d")].buildStyleHtml(CKEDITOR[a0_0x998a("0x3d")].array[a0_0x998a("0x3b")](a[a0_0x998a("0x2d")].exportPdf_stylesheets, l)) : "") + a0_0x998a("0x1f") +
                                    d + '"\x3e' + b + a0_0x998a("0x34"); c.html = b
                            }, null, null, 15); f[a0_0x998a("0x54")]("exportPdf", function (b) {
                                var c = b[a0_0x998a("0x35")][a0_0x998a("0x33")]; delete b.data[a0_0x998a("0x33")]; var g = f[a0_0x998a("0x2d")][a0_0x998a("0x44")]; b = JSON[a0_0x998a("0x5e")](b[a0_0x998a("0x35")]); var e = new XMLHttpRequest, h = a[a0_0x998a("0x2d")][a0_0x998a("0x48")] || "cke4"; e[a0_0x998a("0x0")]("POST", g); e.setRequestHeader(a0_0x998a("0x4c"), a0_0x998a("0xe")); e.setRequestHeader(a0_0x998a("0x2c"), h); if (c) e[a0_0x998a("0xd")](a0_0x998a("0xc"),
                                    c); else CKEDITOR[a0_0x998a("0x2a")]("exportpdf-no-token"); e[a0_0x998a("0x28")] = "blob"; e[a0_0x998a("0x22")](b); k[a0_0x998a("0x20")]({ progress: .5 }); d(e, k)
                            }, null, null, 20); f.fire(a0_0x998a("0x7"), h)
                        }, modes: { wysiwyg: 1 }, readOnly: 1, canUndo: !1
                    }), a.ui[a0_0x998a("0x5c")])) a.ui[a0_0x998a("0x5c")]("ExportPdf", { label: a[a0_0x998a("0x3f")][a0_0x998a("0x2f")][a0_0x998a("0x47")], command: a0_0x998a("0x7"), toolbar: a0_0x998a("0x37") })
                }, createTokenFetcher: function (a, c) {
                    var b = {
                        refreshInterval: a[a0_0x998a("0x43")] || 36E5,
