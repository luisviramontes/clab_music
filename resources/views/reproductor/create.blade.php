                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            ...
                            <form id="wizard-validation-form" action="{{ route('reproductor_admin.store') }}" method="POST" name="formulario" method="post"
                                    ...
                                    <section>
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  name="año" value="{{$year}}" parsley-trigger="change"
                                                    placeholder="Ingresar el año" class="form-control" id="año">
                                            </div>

                                            <div class="form-group">
                                                <h4 class="header-title mb-4">Subir archivo</h4>
                                                <input type="file" accept=".mp3,.MP3" id="archivo" required name="archivo" />
                                            </div>
