            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Registro de formularios</li>
                    </ol>
                </div>
                <h4 class="page-title">Registrar nuevo formulario</h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            ...
                            <form id="wizard-validation-form" action="{{route('formularios.store')}}" name="formulario"
                                ...
                                <div>
                                    ...
                                    <section>
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="nombre" parsley-trigger="change"
                                            ...
                                            <div class="form-group">
                                                <label for="userName">Descripción<span
                                                        class="text-danger"></span></label>
                                                <input type="text" required name="descripcion" parsley-trigger="change"
                                            ...
                                            <div class="form-group">
                                                <label for="userName">Duración aproximada en minutos<span
                                                        class="text-danger"></span></label>
                                                <input type="number" required name="duracion" parsley-trigger="change"
                                    ...
                                    <section>
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="titulo_fin" parsley-trigger="change"
                                                onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                                placeholder="Ingresar el título" class="form-control"
                                                id="titulo_fin">
                                        </div>

                                        <div class="form-group">
                                            <label for="userName">Texto<span class="text-danger"></span></label>
                                            <input type="text" required name="texto_fin" parsley-trigger="change"
                                                placeholder="Ingresar el texto" class="form-control"
                                                id="texto_fin">
                                        </div>
                                        <div class="col-lg-12 ">
                                            <h4 class="header-title mb-4">Imagen de fondo</h4>
                                            <input class="files" type="file" accept=".png, .jpg, .jpeg" id="fondo_fin"
                                                required name="fondo_fin" />
                                        </div>
                                    </section>
