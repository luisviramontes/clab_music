        ...
        <div class="navbar-custom">
            ...
            <div class="logo-box">
                <a href="/welcome" class="logo text-center logo-dark">
                    <span class="logo-lg">
                        <img src="/img/logo_clab.png" alt="" height="32">
                        <!-- <span class="logo-lg-text-dark">Uplon</span> -->
                    </span>
                    <span class="logo-sm">
                        <!-- <span class="logo-lg-text-dark">U</span> -->
                        <img src="/img/logo_clab.png" alt="" height="34">
                    </span>
                </a>

                <a href="/welcome" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="/img/logo_clab.png" alt="" height="22">
                        <!-- <span class="logo-lg-text-dark">Uplon</span> -->
                    </span>
                    <span class="logo-sm">
                        <!-- <span class="logo-lg-text-dark">U</span> -->
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <h3 style="color: white;padding-top: 10px;">Reproductor Clab</h3>
            </ul>
        </div>
        <!-- end Topbar -->
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="/reproductor_admin">Reproductor</a></li>
                            </ul>
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            2022 &copy; Reproductor Clab <a href=""></a>
                        </div>
                    </div>
                </div>
            </footer>
